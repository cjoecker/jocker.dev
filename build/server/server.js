...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0a5e6ca5-f80c-5e80-94a9-d32a59dfac4f")}catch(e){}}();
...
import { setDefaultOptions, differenceInMonths, format as format$1 } from "date-fns";
import { enUS, de, es } from "date-fns/locale";
import { createReadableStreamFromReadable } from "@react-router/node";
import { ServerRouter, useMatches, useActionData, useLoaderData, useParams, useRouteError, redirect, Meta, Links, Outlet, ScrollRestoration, Scripts, isRouteErrorResponse, useNavigate, useNavigation, useSubmit, Form, data } from "react-router";
import { RemixI18Next } from "remix-i18next/server";
import React, { createElement, useEffect, useRef, useState, useCallback, useMemo } from "react";
import * as Sentry from "@sentry/react-router";
import posthog from "posthog-js";
import { useHydrated } from "remix-utils/use-hydrated";
import { useChangeLanguage } from "remix-i18next/react";
import { useInView, motion, useScroll, useTransform, useAnimation, useMotionValue, animate, AnimatePresence } from "framer-motion";
...
const enTranslation = {
  ...
  iDontJustProgramFeatures: "I don't just code features. I help you build scalable apps with amazing user experiences and code that holds up!",
  ...
  christianIsAVery: "Christian is a very creative person with attention to details. He really puts effort in developing what makes sense for the end user. He is also a fan of clean code and good architecture.",
  christianIsAlwaysReliable: "Christian is always reliable! He not only tackles his tasks with determination, but also consistently offers suggestions on how to make our software even more user-friendly. All with complete cost transparency! Anyone who gets to work with him is truly lucky!",
  hePerfectlyEmbodies: "He perfectly embodies the role of a skilled developer, who not only masters his technologies but also has amazing UX know-how. Both his creativity and entrepreneurial mindset bring his projects and the company forward.",
  ...
  pageDescription: "Passionate about creating great experiences with beautiful web applications. Happy customers, clean code, and sustainable architectures are my priorities.",
  pageKeyword: "freelancer,independent,contractor,self-employed,full-stack,full,stack,fullstack,back-end,backend,frontend,front-end,developer,engineer,software,ux,ui,web,designer",
  fullName: "Full Name",
  email: "Email",
  message: "Message",
...
const deTranslation = {
  ...
  iDontJustProgramFeatures: "No solo programo funciones. Te ayudo a construir aplicaciones escalables con experiencias de usuario increíbles y código que perdura.",
  ...
  christianIsAVery: "Christian es una persona muy creativa con atención al detalle. Realmente se esfuerza en desarrollar lo que tiene sentido para el usuario final. También es un fanático del código limpio y la buena arquitectura.",
  ...
  hePerfectlyEmbodies: "Encarna perfectamente el papel de un desarrollador experto, que no solo domina sus tecnologías sino que también tiene un increíble conocimiento de UX. Tanto su creatividad como su mentalidad empresarial impulsan sus proyectos y la empresa.",
  ...
  pageDescription: "Apasionado por crear grandes experiencias con hermosas aplicaciones web. Clientes felices, código limpio y arquitecturas sostenibles son mis prioridades.",
  pageKeyword: "freelancer,independiente,contratista,autónomo,full-stack,full,stack,fullstack,back-end,backend,frontend,front-end,desarrollador,ingeniero,software,ux,ui,web,diseñador",
  ...
  oneDay: "un día",
  error: "¡Error!",
  couldNotSend: "Tu mensaje no pudo ser enviado. Por favor, envíame un correo electrónico a",
...
const RalewayFontRegularWoff = "/assets/raleway-v28-latin-regular-D2N-7lIF.woff";
const RalewayFontRegularWoff2 = "/assets/raleway-v28-latin-regular-D4TnAZR_.woff2";
...
const meta = () => {
  return [{
    ...
    name: "description",
    content: "Passionate about creating great experiences with beautiful web applications. Happy customers, clean code, and sustainable architectures are my priority."
  }, {
    name: "keywords",
    content: "freelancer,independent,contractor,self-employed,full-stack,full,stack,fullstack,back-end,backend,frontend,front-end,developer,engineer,software,ux,ui,web,designer"
  }, {
    name: "viewport",
...
const root = withComponentProps(function Root() {
  ...
  const locale = (loaderData == null ? void 0 : loaderData.locale) ?? fallbackLng;
  ...
  return /* @__PURE__ */ jsxs("html", {
    ...
    children: [/* @__PURE__ */ jsxs("head", {
      ...
      children: [/* @__PURE__ */ jsx(Outlet, {}), /* @__PURE__ */ jsx(ScrollRestoration, {}), /* @__PURE__ */ jsx(Scripts, {}), /* @__PURE__ */ jsx(PosthogInit, {})]
    })]
  });
});
...
function convertToSnakeCase(str) {
  return str.replaceAll(/([A-Z])/g, "_$1").toLowerCase().replace(/^_/, "");
}
...
const Section = ({
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      ref,
      children: [
        !hideTitle && /* @__PURE__ */ jsx("h2", { className: "mb-12 text-xl font-bold", children: t(titleKey) }),
        children2
      ]
    }
  );
...
function useTranslationWithMarkdown() {
  ...
  const tMarkdown = React.useCallback(
    (key, options) => {
      return /* @__PURE__ */ jsx("div", { className: "markdown", children: /* @__PURE__ */ jsx(Markdown, { remarkPlugins: [remarkGfm], children: t(key, options ?? {}) }) });
    },
    [t]
  );
...
const AboutMe = () => {
  ...
  return /* @__PURE__ */ jsx(Section, { titleKey: "aboutMe", hideTitle: true, children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "col-span-1 sm:col-span-2", children: /* @__PURE__ */ jsx(
          "img",
          {
            loading: "lazy",
        ...
        /* @__PURE__ */ jsxs("div", { className: "col-span-1 my-auto text-left sm:col-span-3", children: [
          /* @__PURE__ */ jsx("h3", { className: "mb-4 text-xl font-semibold", children: t("aboutMe") }),
          /* @__PURE__ */ jsx("div", { className: "text-base", children: tm("aboutMeData") }),
          /* @__PURE__ */ jsx(
            "img",
            {
              loading: "lazy",
...
const Button = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "grow-0", children: /* @__PURE__ */ jsx(
    motion.button,
    {
...
const EmailIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20height='24'%20width='24'%20fill='%23fff'%3e%3cpath%20d='M0%200h24v24H0z'%20fill='none'/%3e%3cpath%20d='M20%204H4c-1.1%200-1.99.9-1.99%202L2%2018c0%201.1.9%202%202%202h16c1.1%200%202-.9%202-2V6c0-1.1-.9-2-2-2zm0%204l-8%205-8-5V6l8%205%208-5v2z'/%3e%3c/svg%3e";
...
const Contact = () => {
  return /* @__PURE__ */ jsx(Section, { titleKey: "contact", isLast: true, children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: "hidden",
      whileInView: "visible",
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-9", children: [
          /* @__PURE__ */ jsx(ContactButton, { contactInformation: ContactInformation[0] }),
          /* @__PURE__ */ jsx(ContactButton, { contactInformation: ContactInformation[1] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-9", children: [
          /* @__PURE__ */ jsx(ContactButton, { contactInformation: ContactInformation[2] }),
          /* @__PURE__ */ jsx(ContactButton, { contactInformation: ContactInformation[3] })
        ] })
      ]
    }
  ) });
...
const ContactButton = ({
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      children: isMessageButton ? /* @__PURE__ */ jsx(
        ButtonIcon,
        {
...
const Contributions = () => {
  return /* @__PURE__ */ jsx(Section, { titleKey: "contributions", children: /* @__PURE__ */ jsx("div", { className: "flex", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex flex-wrap justify-center gap-x-24 gap-y-36", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative flex min-w-[250px] flex-col", children: [
      /* @__PURE__ */ jsx(Mesh, {}),
      /* @__PURE__ */ jsx(MyApps, {})
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "relative flex min-w-[270px] flex-col", children: [
      /* @__PURE__ */ jsx(Mesh, {}),
      /* @__PURE__ */ jsx(OpenSource, {})
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "relative flex min-w-[200px] flex-col", children: [
      /* @__PURE__ */ jsx(Mesh, {}),
...
const StackOverflow = () => {
  ...
  const profile = (_a = profilesData == null ? void 0 : profilesData.items) == null ? void 0 : _a[0];
  useEffect(() => {
    try {
      void fetch(STACK_OVERFLOW_API).then((res) => {
        if (!res.ok) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h3", { className: "mb-6 text-lg font-semibold", children: "Stack Overflow" }),
    /* @__PURE__ */ jsx(
      ExternalRedirect,
      {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "-mb-1.5 ml-1", children: "Reputation" }),
                  /* @__PURE__ */ jsx("div", { className: "text-xl", children: ((profile == null ? void 0 : profile.reputation) ?? StackOverflowDefaults.reputation).toLocaleString("en-US") })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mt-1.5 flex w-full justify-between", children: [
                /* @__PURE__ */ jsx(
                  Badge,
                  {
                    color: "#D0A600",
                    number: (profile == null ? void 0 : profile.badge_counts.gold) ?? StackOverflowDefaults.goldBadge
                  }
                ),
                /* @__PURE__ */ jsx(
                  Badge,
                  {
                    color: "#707A81",
                    number: (profile == null ? void 0 : profile.badge_counts.silver) ?? StackOverflowDefaults.silverBadge
                  }
                ),
                /* @__PURE__ */ jsx(
                  Badge,
                  {
                    color: "#986400",
                    number: (profile == null ? void 0 : profile.badge_counts.bronze) ?? StackOverflowDefaults.bronzeBadge
                  }
                )
              ] })
            ]
...
const Badge = ({ color, number }) => {
  return /* @__PURE__ */ jsxs("div", { className: "flex", children: [
    ...
    /* @__PURE__ */ jsx("span", { className: "text-md mb-1 ml-2", children: number })
  ] });
};
const OpenSource = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h3", { className: "mb-6 text-lg font-semibold", children: t("openSourceContributions") }),
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: "hidden",
        ...
        children: OpenSourceContributions.map((contribution) => {
          return /* @__PURE__ */ jsx(ExternalRedirect, { to: contribution.link, children: /* @__PURE__ */ jsxs(
            motion.div,
            {
              whileTap: { scale: 1 },
              whileHover: { scale: 1.1 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-md text-secondary", children: contribution.name })
              ]
            }
          ) }, contribution.name);
        })
...
const MyApps = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h3", { className: "mb-8 text-lg font-semibold", children: t("myApps") }),
              ...
              children: /* @__PURE__ */ jsxs(
                ExternalRedirect,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "max-w-[100px]", children: app.name })
                  ]
                }
              )
            },
...
const CoreValues = () => {
  return /* @__PURE__ */ jsx(Section, { titleKey: "coreValues", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative mx-auto flex", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          alt: "",
      ...
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: CoreValuesData.map((value) => {
            return /* @__PURE__ */ jsx(CoreValue, { coreValue: value }, value.coreValueKey);
          })
        }
      )
    ] }),
    /* @__PURE__ */ jsx("div", { className: "m-auto px-2", children: /* @__PURE__ */ jsx(
      motion.img,
      {
        loading: "lazy",
        width: "350",
...
const CoreValue = ({ coreValue }) => {
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("h3", { className: "text-md font-semibold", children: t(coreValue.coreValueKey) }),
        /* @__PURE__ */ jsx("p", { className: "mt-0.5 opacity-90", children: t(coreValue.explanationKey) })
      ]
    }
  );
};
...
function useFormatDates() {
  ...
  const formatTimePeriod = (startDate, endDate) => {
    const newEndDate = endDate === "today" ? /* @__PURE__ */ new Date() : endDate;
    ...
    const distance = distanceInYears > 1 ? `${numberFormatter.format(distanceInYears)}${t("yearAbbreviation")}` : `${differenceInMonths(newEndDate, startDate)}${t("monthAbbreviation")}`;
    return endDate === "today" ? `${formatDate(startDate)} - ${t("present")} (${distance})` : `${formatDate(startDate)} - ${formatDate(endDate)} (${distance})`;
  };
  return {
    formatDate,
    formatTimePeriod
...
const CoursesAndConferences = () => {
  ...
  return /* @__PURE__ */ jsx(Section, { titleKey: "coursesAndConferences", children: /* @__PURE__ */ jsx("div", { className: "mx-0 flex w-full flex-col sm:mx-2", children: /* @__PURE__ */ jsxs("div", { className: "relative mx-auto flex max-w-6xl", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
        alt: "",
        ...
        children: sortedCoursesAndConferences.map((course) => {
          return /* @__PURE__ */ jsx(
            motion.div,
            {
              ...
              children: "instructor" in course ? /* @__PURE__ */ jsx(CourseItem, { course }) : /* @__PURE__ */ jsx(ConferenceItem, { conference: course })
            },
            course.name
          );
        })
...
const CourseItem = ({ course }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "truncate text-base", children: course.name }),
      /* @__PURE__ */ jsx("div", { className: "text-sm opacity-80", children: `${course.instructor} – ${formatDate(course.date)}` })
    ] })
  ] });
};
const ConferenceItem = ({ conference }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "truncate text-base", children: conference.name }),
      /* @__PURE__ */ jsx("div", { className: "text-sm opacity-80", children: formatDate(conference.date) })
    ] })
  ] });
};
...
const ExperienceAndEducation = () => {
  return /* @__PURE__ */ jsx(Section, { titleKey: "experienceAndEducation", children: /* @__PURE__ */ jsx(WorkExperience, {}) });
};
const WorkExperience = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex w-full flex-col", children: workAndEducation.map((experienceItem, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        className: "mx-4 flex",
        children: [
          /* @__PURE__ */ jsx("div", { className: "min-w-0 flex-1", children: !isOdd && /* @__PURE__ */ jsx(ExperienceItem, { isOdd, item: experienceItem }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 grow-0 flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "flex-1 pb-2", children: /* @__PURE__ */ jsx(
              "span",
              {
              ...
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsx(
                  "img",
                  {
                    ...
                    width: "40",
                    height: "40",
                    alt: experienceItem.type === "work" ? "office building" : "graduate cap",
                    src: experienceItem.type === "work" ? OfficeImg : GraduateCap
                  }
                )
              }
            ),
            /* @__PURE__ */ jsx("div", { className: "flex-1 pt-2", children: /* @__PURE__ */ jsx(
              "span",
              {
...
const ExperienceItem = ({
  ...
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mb-2 max-w-[300px]", children: [
        /* @__PURE__ */ jsx(ExternalRedirect, { to: item.link, children: /* @__PURE__ */ jsx(
          motion.img,
          {
            whileTap: { scale: 1 },
            whileHover: { scale: 1.1 },
        ...
        /* @__PURE__ */ jsx("div", { className: "text-sm leading-tight opacity-80 md:text-base", children: formatTimePeriod(item.startDate, item.endDate) }),
        /* @__PURE__ */ jsx("div", { className: "text-sm leading-tight opacity-80 md:text-base", children: t(item.locationKey) })
      ] })
    }
  );
};
...
const Facts = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx(Section, { titleKey: "facts", children: /* @__PURE__ */ jsx("div", { className: "relative mt-12 flex", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid grid-cols-1 flex-wrap justify-between gap-x-12 gap-y-8 lg:grid-cols-3", children: [
    /* @__PURE__ */ jsx(
      Fact,
      {
...
const Fact = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative col-span-1 flex min-w-[220px] flex-col rounded-lg p-4", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
        "aria-hidden": "true",
    ...
    /* @__PURE__ */ jsx("div", { ref, className: "mt-3 text-2xl font-semibold" }),
    /* @__PURE__ */ jsx("div", { className: "mt-4 text-xl", children: label })
  ] });
};
function on(obj) {
  var args = [];
...
const useLocation = isBrowser && hasEventConstructor ? useLocationBrowser : useLocationServer;
...
const MessageFloatingButton = () => {
  ...
  useEffect(() => {
    if (hiddenMessageButtonSections.has(visibleSection) || location2.pathname === "/contact") {
...
const Footer = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto mb-2 w-full", children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: "z-10 mt-4 mb-8 ml-6 text-left sm:mt-[20vh] sm:mb-20 sm:ml-24",
            children: [
              /* @__PURE__ */ jsxs(
                motion.h1,
                {
              ...
              /* @__PURE__ */ jsx(
                motion.button,
                {
                  ...
                  children: /* @__PURE__ */ jsx("div", { className: "bg-neutral-dark/80 pointer-events-none m-[1px] rounded-md px-6 py-4", children: t("discoverMore") })
                }
              )
            ]
          }
...
function AnimatedWord() {
  ...
  return /* @__PURE__ */ jsxs("span", { className: "flex flex-wrap", "aria-label": ariaLabel, children: [
    `${t("fullStackDeveloperPrefix")}${SPACE_CHAR}`,
    words.map((word, wordIndex2) => {
      const wordWithSpaces = wordIndex2 + 1 === words.length ? word : word + SPACE_CHAR;
      const letters = [...wordWithSpaces];
      const prevWordsLength = words.slice(0, wordIndex2).reduce((acc, curr) => {
                ...
                variants: {
                  hidden: {
                    ...
                    transition: {
                      ...
                      delay: (textLength - prevWordsLength - index - 1) * STAGGER_DURATION
                    }
                  },
                  visible: {
                    opacity: 1,
...
const Languages = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx(Section, { titleKey: "languages", className: "flex flex-col", children: /* @__PURE__ */ jsx("div", { className: "mx-auto grid max-w-7xl grid-cols-1 gap-x-32 gap-y-20 md:grid-cols-4", children: LanguagesData.map((language) => {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-md font-bold", children: t(language.languageKey) }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-base", children: t(language.levelKey) })
        ]
      },
...
const ServiceOffer = () => {
  ...
  return /* @__PURE__ */ jsx(Section, { titleKey: "whatICanDoForYou", className: "mt-16", children: /* @__PURE__ */ jsxs("div", { className: "relative flex", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
        alt: "",
...
const Card = ({
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      ...appearAnimation,
      children: [
        isOpen && /* @__PURE__ */ jsx("div", { className: "relative z-0", children: /* @__PURE__ */ jsx(CardContent, { offer, isOpen }) }),
        /* @__PURE__ */ jsx(
          motion.div,
          {
            onClick,
            ...
            children: /* @__PURE__ */ jsx(CardContent, { isExpandable: true, offer, isOpen })
          }
        )
      ]
    },
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(
                ...
                {
                  layout: isExpandable ? "preserve-aspect" : false,
                  className: isOpen ? "mt-2 mr-4 mb-3 text-lg font-semibold" : "mb-1 text-lg",
                  children: t(offer.titleKey)
                }
              ),
              isOpen && /* @__PURE__ */ jsx(motion.div, { className: "my-2 text-base", children: tm(offer.descriptionTranslationKey, { years: EXPERIENCE_YEARS }) })
            ]
          }
        )
      ]
...
const Skills = () => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx(Section, { titleKey: "skills", className: "mx-8 flex flex-col sm:mx-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl grid-cols-1 gap-x-16 gap-y-20 md:grid-cols-2", children: [
    /* @__PURE__ */ jsx(Tags, { skills: DevSkills, title: t("webDevelopment") }),
...
const Tags = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "col-span-1 mt-4", children: [
    /* @__PURE__ */ jsx("h3", { className: "mb-4 text-left text-lg font-semibold", children: title }),
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: "hidden",
...
function Elements(Splide22, Components2, options) {
  var _EventInterface = EventInterface(Splide22), on2 = _EventInterface.on, bind = _EventInterface.bind;
...
function Slide$1(Splide22, index, slideIndex, slide) {
  ...
  var Components = Splide22.Components, root2 = Splide22.root, options = Splide22.options;
  ...
  function mount() {
    if (!isClone) {
      ...
      setAttribute(slide, ARIA_LABEL, label || format(i18n2.slideLabel, [index + 1, Splide22.length]));
    }
    listen();
  }
  function listen() {
...
function Slides(Splide22, Components2, options) {
  var _EventInterface2 = EventInterface(Splide22), on2 = _EventInterface2.on, emit = _EventInterface2.emit, bind = _EventInterface2.bind;
...
function Layout(Splide22, Components2, options) {
  var _EventInterface3 = EventInterface(Splide22), on2 = _EventInterface3.on, bind = _EventInterface3.bind, emit = _EventInterface3.emit;
...
function Move(Splide22, Components2, options) {
  var _EventInterface4 = EventInterface(Splide22), on2 = _EventInterface4.on, emit = _EventInterface4.emit;
...
function Controller(Splide22, Components2, options) {
  var _EventInterface5 = EventInterface(Splide22), on2 = _EventInterface5.on, emit = _EventInterface5.emit;
...
function Autoplay(Splide22, Components2, options) {
  var _EventInterface6 = EventInterface(Splide22), on2 = _EventInterface6.on, bind = _EventInterface6.bind, emit = _EventInterface6.emit;
...
function Cover(Splide22, Components2, options) {
  var _EventInterface7 = EventInterface(Splide22), on2 = _EventInterface7.on;
  function mount() {
    if (options.cover) {
...
function Scroll(Splide22, Components2, options) {
  var _EventInterface8 = EventInterface(Splide22), on2 = _EventInterface8.on, emit = _EventInterface8.emit;
  var set = Splide22.state.set;
  var Move2 = Components2.Move;
...
function Drag(Splide22, Components2, options) {
  var _EventInterface9 = EventInterface(Splide22), on2 = _EventInterface9.on, emit = _EventInterface9.emit, bind = _EventInterface9.bind, unbind = _EventInterface9.unbind;
  var state = Splide22.state;
...
function Keyboard(Splide22, Components2, options) {
  var _EventInterface10 = EventInterface(Splide22), on2 = _EventInterface10.on, bind = _EventInterface10.bind, unbind = _EventInterface10.unbind;
  var root2 = Splide22.root;
  var resolve = Components2.Direction.resolve;
  var target;
  var disabled;
...
function LazyLoad(Splide22, Components2, options) {
  var _EventInterface11 = EventInterface(Splide22), on2 = _EventInterface11.on, off2 = _EventInterface11.off, bind = _EventInterface11.bind, emit = _EventInterface11.emit;
...
function Live(Splide22, Components2, options) {
  var _EventInterface13 = EventInterface(Splide22), on2 = _EventInterface13.on;
...
var Splide2 = class extends React.Component {
  ...
  render() {
    const { className, tag: Root2 = "div", hasTrack = true, children: children2, ...props } = this.props;
    ...
    }, hasTrack ? /* @__PURE__ */ React.createElement(SplideTrack, null, children2) : children2);
  }
};
...
function Testimonials() {
  ...
  const getIndex = useCallback(
    (direction) => {
      ...
      } else if (direction === "next" && currentSlideIndex >= testimonials.length - 1) {
        return 0;
  ...
  return /* @__PURE__ */ jsxs(Section, { titleKey: "testimonials", className: "relative mx-auto max-w-[900px]", children: [
    /* @__PURE__ */ jsx(
      Splide2,
      {
        ref: splideRef,
        ...
        children: /* @__PURE__ */ jsx(SplideTrack, { className: "mask-swiper-narrow", children: testimonials.map((testimonial) => {
          return /* @__PURE__ */ jsx(SplideSlide, { children: /* @__PURE__ */ jsxs(
            "div",
            {
              className: "shadow-sm-turquoise border-secondary/10 from-neutral to-neutral-dark mx-4 my-6 flex h-full flex-1 cursor-grab flex-col rounded-xl border-2 border-solid bg-linear-to-br p-5 select-none",
              children: [
                /* @__PURE__ */ jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col justify-center", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "text-base", children: t(testimonial.testimonialKey) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mx-auto my-2 flex justify-end text-left", children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
                      loading: "lazy",
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "my-auto flex flex-col justify-end", children: [
                    /* @__PURE__ */ jsx("div", { className: "text-md font-bold", children: testimonial.person }),
                    /* @__PURE__ */ jsx("div", { className: "text-base", children: t(testimonial.titleKey) }),
                    /* @__PURE__ */ jsx("div", { className: "text-sm", children: t(testimonial.company) })
                  ] })
                ] })
              ]
            }
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute top-0 flex h-full w-full flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-full w-full max-w-5xl justify-between", children: [
        /* @__PURE__ */ jsx(
          ChangeButton,
          {
            orientation: "left",
      ...
      /* @__PURE__ */ jsx("div", { children: testimonials.map((testimonial, index) => {
        return /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(
              ...
              {
                style: {
                  boxShadow: currentSlideIndex === index ? `${colors.primary} 0px 0px 12px 6px` : "unset"
                },
...
const _index = withComponentProps(function Index() {
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [/* @__PURE__ */ jsx(LoadingBar, {}), /* @__PURE__ */ jsx(Header, {}), /* @__PURE__ */ jsx("div", {
      className: "flex w-full flex-col",
      children: /* @__PURE__ */ jsxs("div", {
        className: "",
        children: [/* @__PURE__ */ jsx(ServiceOffer, {}), /* @__PURE__ */ jsx(Facts, {}), /* @__PURE__ */ jsx(Skills, {}), /* @__PURE__ */ jsx(CoreValues, {}), /* @__PURE__ */ jsx(Testimonials, {}), /* @__PURE__ */ jsx(ExperienceAndEducation, {}), /* @__PURE__ */ jsx(Contributions, {}), /* @__PURE__ */ jsx(CoursesAndConferences, {}), /* @__PURE__ */ jsx(Languages, {}), /* @__PURE__ */ jsx(AboutMe, {}), /* @__PURE__ */ jsx(Contact, {}), /* @__PURE__ */ jsx(Footer, {})]
      })
    }), /* @__PURE__ */ jsx(Outlet, {}), /* @__PURE__ */ jsx(MessageFloatingButton, {})]
  });
});
const LoadingBar = () => {
  ...
  return /* @__PURE__ */ jsx("div", {
    className: "bg-grey fixed top-0 right-0 left-0 z-50 h-1 w-screen overflow-hidden",
...
const contact = withComponentProps(function Contact2() {
  ...
  const captureFormData = () => {
    ...
    const email = formElements == null ? void 0 : formElements.namedItem("email");
    const message = formElements == null ? void 0 : formElements.namedItem("message");
    if ((name == null ? void 0 : name.value) || (email == null ? void 0 : email.value) && (message == null ? void 0 : message.value)) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [/* @__PURE__ */ jsx(motion.div, {
      ...
      children: /* @__PURE__ */ jsxs(motion.div, {
        ...
        }), submitSuccess !== void 0 && (submitSuccess ? /* @__PURE__ */ jsx(SubmitSuccess, {}) : /* @__PURE__ */ jsx(SubmitError, {
          personalEmail: (data2 == null ? void 0 : data2.personalEmail) ?? ""
        })), submitSuccess === void 0 && /* @__PURE__ */ jsx(ContactForm, {
          formRef
        })]
      })
    })]
...
const ContactForm = ({
  ...
  return /* @__PURE__ */ jsxs(Form, {
    ...
    children: [/* @__PURE__ */ jsx(Textbox, {
      ...
      children: [t("message"), /* @__PURE__ */ jsx("textarea", {
        onChange: (e) => {
      ...
      children: [/* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsx(AnimatePresence, {
          children: error !== "" && hasTriedToSubmit && /* @__PURE__ */ jsx(motion.div, {
            layout: true,
            initial: {
              y: 20,
              opacity: 0
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx(Lottie, {
      ...
      children: [/* @__PURE__ */ jsx("div", {
        ...
        children: [t("responseTime"), " ", /* @__PURE__ */ jsx("span", {
          className: "font-bold",
          children: t("oneDay")
        }), "."]
      })]
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("div", {
      ...
      children: [/* @__PURE__ */ jsx("div", {
        ...
        children: [t("couldNotSend"), " ", /* @__PURE__ */ jsx("a", {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CkOIU9JT.js", "imports": ["/assets/chunk-D4RADZKF-DVqrdyfo.js", "/assets/i18n-CcYMxFnS.js", "/assets/es-U_uln9Pb.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": true, "module": "/assets/root-D-xMKFFd.js", "imports": ["/assets/chunk-D4RADZKF-DVqrdyfo.js", "/assets/i18n-CcYMxFnS.js", "/assets/es-U_uln9Pb.js", "/assets/with-props-DPDmm-s_.js", "/assets/use-hydrated-Bl0M1cM4.js", "/assets/misc-CkINB2q5.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": "/:locale", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/_index-OIRC3iXb.js", "imports": ["/assets/with-props-DPDmm-s_.js", "/assets/chunk-D4RADZKF-DVqrdyfo.js", "/assets/use-hydrated-Bl0M1cM4.js", "/assets/button-Wq5pn2Q5.js", "/assets/misc-CkINB2q5.js", "/assets/es-U_uln9Pb.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/contact": { "id": "routes/contact", "parentId": "routes/_index", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/contact-DZG6Wt4L.js", "imports": ["/assets/with-props-DPDmm-s_.js", "/assets/chunk-D4RADZKF-DVqrdyfo.js", "/assets/use-hydrated-Bl0M1cM4.js", "/assets/button-Wq5pn2Q5.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/not-found": { "id": "routes/not-found", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/not-found-8hKXd7jQ.js", "imports": ["/assets/with-props-DPDmm-s_.js", "/assets/chunk-D4RADZKF-DVqrdyfo.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-e8f70707.js", "version": "e8f70707", "sri": void 0 };

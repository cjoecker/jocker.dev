!(function () {
	try {
		...
		n &&
			...
			(e._sentryDebugIds[n] = "cd859ac8-54dc-5d09-94c6-7fae3f87b23b"));
	} catch (e) {}
})();
import { u as ge, w as yu } from "./with-props-DPDmm-s_.js";
import {
	b as Q,
	w as Be,
	p as g,
...
import { u as bu, i as ku } from "./use-hydrated-Bl0M1cM4.js";
import {
	i as Su,
	f as Lt,
	c as Ai,
	...
	I as ol,
	J as ni,
} from "./button-Wq5pn2Q5.js";
import { P as $u } from "./misc-CkINB2q5.js";
import { g as ur, e as Di, a as Gu, d as qu } from "./es-U_uln9Pb.js";
const ll = 6048e5,
	Yu = 864e5,
	wa = Symbol.for("constructDateFrom");
function at(e, t) {
	return typeof e == "function"
		? e(t)
		: e && typeof e == "object" && wa in e
			? e[wa](t)
			: e instanceof Date
				? new e.constructor(t)
				: new Date(t);
...
function ln(e, t) {
	...
	const n = ur(),
		r =
			...
			((s = (l = t == null ? void 0 : t.locale) == null ? void 0 : l.options) ==
			null
				? void 0
				: s.weekStartsOn) ??
			n.weekStartsOn ??
...
function Ku(e, t, n) {
	const [r, i] = Li(n == null ? void 0 : n.in, e, t),
		o = ka(r),
		a = ka(i),
		l = +o - ba(o),
		s = +a - ba(a);
...
function Ju(e) {
	return !((!Qu(e) && typeof e != "number") || isNaN(+ye(e)));
}
function Zu(e, t, n) {
	const [r, i] = Li(n == null ? void 0 : n.in, e, t),
...
function nc(e, t) {
	const n = ye(e, t == null ? void 0 : t.in);
	return +ec(n, t) == +tc(n, t);
}
function Sa(e, t, n) {
	const [r, i, o] = Li(n == null ? void 0 : n.in, e, e, t),
		a = Ir(i, o),
		l = Math.abs(Zu(i, o));
	if (l < 1) return 0;
	i.getMonth() === 1 && i.getDate() > 27 && i.setDate(30),
		i.setMonth(i.getMonth() - a * l);
	let s = Ir(i, o) === -a;
	nc(r) && l === 1 && Ir(r, o) === 1 && (s = !1);
	const u = a * (l - +s);
	return u === 0 ? 0 : u;
}
function rc(e, t) {
...
function ul(e, t) {
	...
	const n = ye(e, t == null ? void 0 : t.in),
		...
		o =
			...
			((h = (d = i.locale) == null ? void 0 : d.options) == null
				? void 0
				: h.firstWeekContainsDate) ??
			1,
		a = at((t == null ? void 0 : t.in) || e, 0);
	a.setFullYear(r + 1, 0, o), a.setHours(0, 0, 0, 0);
	const l = ln(a, t),
		s = at((t == null ? void 0 : t.in) || e, 0);
...
function oc(e, t) {
	...
	const n = ur(),
		r =
			...
			1,
		i = ul(e, t),
		o = at((t == null ? void 0 : t.in) || e, 0);
	return o.setFullYear(i, 0, r), o.setHours(0, 0, 0, 0), ln(o, t);
}
function lc(e, t) {
	const n = ye(e, t == null ? void 0 : t.in),
		r = +ln(n, t) - +oc(n, t);
...
function Ca(e, t = "") {
	const n = e > 0 ? "-" : "+",
		...
		i = Math.trunc(r / 60),
		o = r % 60;
	return o === 0 ? n + String(i) : n + String(i) + t + ae(o, 2);
}
function Aa(e, t) {
	return e % 60 === 0
...
const Ta = (e, t) => {
	...
	sc = (e, t) => {
		...
		return o.replace("{{date}}", Ta(r, t)).replace("{{time}}", cl(i, t));
	},
	uc = { p: cl, P: sc },
	cc = /^D+$/,
	fc = /^Y+$/,
...
function kc(e, t, n) {
	var c, f, d, h, m, x, S, y;
	const r = ur(),
		i = (n == null ? void 0 : n.locale) ?? r.locale ?? Di,
		o =
		...
		a =
			...
			((x = (m = n == null ? void 0 : n.locale) == null ? void 0 : m.options) ==
			null
				? void 0
				: x.weekStartsOn) ??
			r.weekStartsOn ??
			((y = (S = r.locale) == null ? void 0 : S.options) == null
				? void 0
				: y.weekStartsOn) ??
			0,
		l = ye(e, n == null ? void 0 : n.in);
	if (!Ju(l)) throw new RangeError("Invalid time value");
	let s = t
		.match(yc)
		.map((w) => {
			const b = w[0];
		...
		.map((w) => {
			...
			const b = w[0];
			if (b === "'") return { isToken: !1, value: Sc(w) };
			if (Ea[b]) return { isToken: !0, value: w };
			if (b.match(bc))
	...
	return s
		.map((w) => {
			...
			const b = w.value;
			((!(n != null && n.useAdditionalWeekYearTokens) && mc(b)) ||
				(!(n != null && n.useAdditionalDayOfYearTokens) && dc(b))) &&
				pc(b, t, String(e));
			const N = Ea[b[0]];
			return N(l, b, i.localize, u);
		})
		.join("");
}
function Sc(e) {
...
function fl(e, t) {
	return Su(e) ? e[Ec(0, e.length, t)] : e;
}
class Cc {
	constructor(t) {
...
function Dc({ target: e, contentRect: t, borderBoxSize: n }) {
	var r;
	(r = Vn.get(e)) == null ||
		r.forEach((i) => {
			i({
...
function Pc() {
	typeof ResizeObserver > "u" || (rt = new ResizeObserver(Lc));
}
function Nc(e, t) {
	rt || Pc();
	const n = Ti(e);
	return (
		n.forEach((r) => {
			let i = Vn.get(r);
			i || ((i = new Set()), Vn.set(r, i)),
				i.add(t),
				rt == null || rt.observe(r);
		}),
		() => {
			n.forEach((r) => {
				const i = Vn.get(r);
				i == null || i.delete(t),
					(i != null && i.size) || rt == null || rt.unobserve(r);
			});
		}
	);
}
...
function Oc(e) {
	return (
		...
		en || _c(),
		() => {
			Hn.delete(e), !Hn.size && en && (en = void 0);
		}
	);
}
function Mc(e, t) {
	return typeof e == "function" ? Oc(e) : Nc(e, t);
}
const zc = 50,
	Ia = () => ({
		current: 0,
...
function Da(e, t, n, r) {
	...
	(i.current = e[`scroll${a}`]),
		...
		(i.progress = tl(0, i.scrollLength, i.current));
	const u = r - s;
	i.velocity = u > zc ? 0 : Eu(i.current - l, u);
}
function jc(e, t, n) {
	Da(e, "x", t, n), Da(e, "y", t, n), (t.time = n);
}
function Bc(e, t) {
	const n = { x: 0, y: 0 };
	let r = e;
	for (; r && r !== t; )
		if (r instanceof HTMLElement)
			...
			let a = null,
				l = r.parentNode;
			for (; !a; ) l.tagName === "svg" && (a = l), (l = r.parentNode);
			r = a;
		} else break;
	return n;
}
...
function La(e, t, n = 0) {
	let r = 0;
	if ((e in ri && (e = ri[e]), typeof e == "string")) {
...
function Hc(e, t, n, r) {
	...
	return (
		typeof e == "number"
			...
			: typeof e == "string" &&
				((e = e.trim()),
				e.includes(" ") ? (i = e.split(" ")) : (i = [e, ri[e] ? e : "0"])),
		(o = La(i[0], n, r)),
		(a = La(i[1], t)),
		o - a
	);
...
function Gc(e, t, n) {
	const { offset: r = Uc.All } = n,
		{ target: i = e, axis: o = "y" } = n,
		a = o === "y" ? "height" : "width",
		l = i !== e ? Bc(i, e) : Wc,
		s = i === e ? { width: e.scrollWidth, height: e.scrollHeight } : $c(i),
		u = { width: e.clientWidth, height: e.clientHeight };
	t[o].offset.length = 0;
	let c = !t[o].interpolate;
	const f = r.length;
	for (let d = 0; d < f; d++) {
		const h = Hc(r[d], u[a], s[a], l[o]);
		!c && h !== t[o].interpolatorOffsets[d] && (c = !0), (t[o].offset[d] = h);
	}
	c &&
		((t[o].interpolate = el(t[o].offset, nl(r), { clamp: !1 })),
		(t[o].interpolatorOffsets = [...t[o].offset])),
		(t[o].progress = Cu(0, 1, t[o].interpolate(t[o].current)));
}
function qc(e, t = e, n) {
...
function Yc(e, t, n, r = {}) {
	return {
		measure: () => qc(e, r.target, n),
		update: (i) => {
			jc(e, n, i), (r.offset || r.target) && Gc(e, n, r);
		},
		notify: () => t(n),
	};
}
const Gt = new WeakMap(),
	Pa = new WeakMap(),
	Dr = new WeakMap(),
	Na = (e) => (e === document.scrollingElement ? window : e);
function dl(e, { container: t = document.scrollingElement, ...n } = {}) {
	if (!t) return rl;
	let r = Dr.get(t);
	r || ((r = new Set()), Dr.set(t, r));
	const i = Rc(),
		o = Yc(t, e, i, n);
	if ((r.add(o), !Gt.has(t))) {
		const l = () => {
			...
			s = () => {
				for (const d of r) d.update(Au.timestamp);
			},
			u = () => {
				for (const d of r) d.notify();
			},
			c = () => {
				Lt.read(l), Lt.read(s), Lt.preUpdate(u);
			};
		Gt.set(t, c);
		const f = Na(t);
		window.addEventListener("resize", c, { passive: !0 }),
			t !== document.documentElement && Pa.set(t, Mc(t, c)),
	...
	return (
		...
		() => {
			...
			Gt.delete(t),
				s &&
					(Na(t).removeEventListener("scroll", s),
					(u = Pa.get(t)) == null || u(),
...
function ml({ source: e, container: t, ...n }) {
	const { axis: r } = n;
	e && (t = e);
	const i = _a.get(t) ?? new Map();
	_a.set(t, i);
...
function Zc(
	...
	return typeof e == "function" ? Jc(e, i) : Xc(e, i);
}
function Oa(e, t) {
	Iu(!!(!t || t.current));
}
...
function pl({ container: e, target: t, layoutEffect: n = !0, ...r } = {}) {
	const i = sr(ef);
	return (
		(n ? Ii : Q.useEffect)(
			() => (
...
function ii(e) {
	const t = sr(() => Jt(e)),
		{ isStatic: n } = Q.useContext(Du);
	if (n) {
		const [, r] = Q.useState(e);
		Q.useEffect(() => t.on("change", r), []);
	}
	return t;
}
function gl(e, t) {
...
function tf(e) {
	(Tr.current = []), e();
	const t = gl(Tr.current, e);
	return (Tr.current = void 0), t;
}
function Jn(e, t, n, r) {
	if (typeof e == "function") return tf(e);
	const i = typeof t == "function" ? t : Tc(t, n, r);
	return Array.isArray(e) ? Ma(e, i) : Ma([e], ([o]) => i(o));
}
function Ma(e, t) {
	const n = sr(() => []);
	return gl(e, () => {
...
function rf(e, t) {
	if (Array.isArray(t)) return ai(e, t);
	if (typeof t == "string") return ai(e, [t]);
	il(e, t);
}
function af() {
	const e = new Set(),
		t = {
			...
			start(n, r) {
				...
				return (
					e.forEach((o) => {
						i.push(Lu(o, n, { transitionOverride: r }));
					}),
					Promise.all(i)
				);
			},
...
function lf(e, t, n) {
	for (let r = 0; r < e.length; r++) {
		const i = e[r];
		i.at > t && i.at < n && (Nu(e, i), r--);
	}
}
function sf(e, t, n, r, i, o) {
	lf(e, i, o);
	for (let a = 0; a < t.length; a++)
		e.push({ value: t[a], at: Pu(i, o, r[a]), easing: fl(n, a) });
}
function uf(e, t) {
...
const ff = "easeInOut";
function hf(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
	...
	for (let h = 0; h < e.length; h++) {
		...
		if (typeof m == "string") {
			...
			u.set(m.name, za(f, m.at, c, u));
			continue;
		}
		let [x, S, y = {}] = m;
		y.at !== void 0 && (f = za(f, y.at, c, u));
		let w = 0;
		const b = (N, L, E, I = 0, M = 0) => {
			const z = df(N),
				{
					delay: k = 0,
					times: C = nl(z),
			...
			let { ease: W = t.ease || "easeOut", duration: B } = L;
			const V = typeof k == "function" ? k(I, M) : k,
				p = z.length,
				j = Mu(A) ? A : i == null ? void 0 : i[A];
			if (p <= 2 && j) {
				let he = 100;
				if (p === 2 && gf(z)) {
					const ie = z[1] - z[0];
				...
				const _ = { ...q };
				B !== void 0 && (_.duration = zu(B));
				const J = _u(_, he, j);
				(W = J.ease), (B = J.duration);
			}
			B ?? (B = o);
			const $ = f + V;
			C.length === 1 && C[0] === 0 && (C[1] = 1);
			const v = C.length - z.length;
			if ((v > 0 && Ou(C, v), z.length === 1 && z.unshift(null), T)) {
				B = of(B, T);
				const he = [...z],
					_ = [...C];
				...
				for (let ie = 0; ie < T; ie++) {
					...
					for (let ne = 0; ne < he.length; ne++)
						C.push(_[ne] + (ie + 1)),
							W.push(ne === 0 ? "linear" : fl(J, ne - 1));
				}
				uf(C, T);
			}
			const re = $ + B;
			sf(E, z, W, C, $, re), (w = Math.max(V + B, w)), (d = Math.max(re, d));
		};
		if (al(x)) {
			const N = Ra(x, l);
			b(S, y, Fa("default", N));
			...
			for (let E = 0; E < L; E++) {
				...
				const I = N[E],
					M = Ra(I, l);
				for (const z in S) b(S[z], mf(y, z), Fa(z, M), E, L);
			}
		}
		(c = f), (f += w);
	}
		...
		l.forEach((h, m) => {
			for (const x in h) {
				...
				for (let L = 0; L < S.length; L++) {
					const { at: E, value: I, easing: M } = S[L];
					y.push(I), w.push(tl(0, d, E)), b.push(M || "easeOut");
				}
				w[0] !== 0 && (w.unshift(0), y.unshift(y[0]), b.unshift(ff)),
					w[w.length - 1] !== 1 && (w.push(1), y.push(null)),
					a.has(m) || a.set(m, { keyframes: {}, transition: {} });
				const N = a.get(m);
				(N.keyframes[x] = y),
					(N.transition[x] = { ...t, duration: d, ease: b, times: w, ...n });
			}
		}),
		a
	);
...
function bf(e, t) {
	return al(e) || typeof e == "number" || (typeof e == "string" && !Pi(t));
}
function yl(e, t, n, r) {
	const i = [];
	if (bf(e, t)) i.push(Hu(e, (Pi(t) && t.default) || t, n && (n.default || n)));
	else {
		const o = xl(e, t, r),
			a = o.length;
		for (let l = 0; l < a; l++) {
			const s = o[l],
				u = s instanceof Element ? vf : wf;
			Xn.has(s) || u(s);
			const c = Xn.get(s),
				f = { ...n };
			"delay" in f && typeof f.delay == "function" && (f.delay = f.delay(l, a)),
				i.push(...Uu(c, { ...t, transition: f }, {}));
		}
	}
	return i;
}
...
function Ef(e) {
	function t(n, r, i) {
		let o = [];
		return Sf(n) ? (o = kf(n, r, e)) : (o = yl(n, r, i, e)), new Ac(o);
	}
	return t;
}
const Cf = Ef();
...
const vl = Af,
	Tf = { some: 0, all: 1 };
function If(e, t, { root: n, margin: r, amount: i = "some" } = {}) {
	const o = Ti(e),
		a = new WeakMap(),
		l = (u) => {
			u.forEach((c) => {
				...
				if (c.isIntersecting !== !!f)
					if (c.isIntersecting) {
						...
						typeof d == "function" ? a.set(c.target, d) : s.unobserve(c.target);
					} else typeof f == "function" && (f(c), a.delete(c.target));
			});
		},
	...
	return o.forEach((u) => s.observe(u)), () => s.disconnect();
}
function Df(
	e,
	{ root: t, margin: n, amount: r, once: i = !1, initial: o = !1 } = {},
) {
	const [a, l] = Q.useState(o);
	return (
		Q.useEffect(() => {
			if (!e.current || (i && a)) return;
			const s = () => (l(!0), i ? void 0 : () => l(!1)),
				u = { root: (t && t.current) || void 0, margin: n, amount: r };
			return If(e.current, s, u);
		}, [t, e, n, i, r]),
		a
	);
}
const Lf = "/assets/christian-DJWipWPs.jpg",
	Pf = "/assets/signature-Dcas16_p.svg",
	ja = (e) => {
		let t;
		const n = new Set(),
			r = (u, c) => {
...
function Rf(e, t) {
	const n = Df(e),
		r = bu(),
		i = Q.useRef(!1),
		{ setVisibleSection: o } = wl();
	Q.useEffect(() => {
		if ((!i.current && n && (i.current = !0), r && i.current)) {
			const a = zf(t);
			ku.capture("user_sees_section", { is_visible: n, section_name: a }),
				n && o(a);
		}
	}, [r, n, o, t]);
}
const ze = ({
	...
	return (
		Rf(a, e),
		g.jsxs("section", {
			className: `mx-4 ${i ? "mb-12" : "mb-[30vh]"} max-w-[100vw] ${r}`,
			ref: a,
			children: [
				!t &&
					g.jsx("h2", { className: "mb-12 text-xl font-bold", children: o(e) }),
				n,
			],
		})
	);
...
const jf = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
	Bf = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
	Vf = {};
function Va(e, t) {
	return (Vf.jsx ? Bf : jf).test(e);
}
const Hf = /[ \t\n\f\r]/g;
function Uf(e) {
	return typeof e == "object" ? (e.type === "text" ? Ha(e.value) : !1) : Ha(e);
}
function Ha(e) {
	return e.replace(Hf, "") === "";
}
...
class Ni extends Ee {
	constructor(t, n, r, i) {
		let o = -1;
		if ((super(t, n), Ua(this, "space", i), typeof r == "number"))
			for (; ++o < Lr.length; ) {
				const a = Lr[o];
				Ua(this, Lr[o], (r & si[a]) === si[a]);
			}
	}
}
...
function jt(e) {
	...
	for (const [r, i] of Object.entries(e.properties)) {
		const o = new Ni(r, e.transform(e.attributes || {}, r), i, e.space);
		e.mustUseProperty &&
...
function Xf(e, t) {
	...
	if (n.length > 4 && n.slice(0, 4) === "data" && Kf.test(t)) {
		if (t.charAt(4) === "-") {
			const o = t.slice(5).replace(Wa, Jf);
			r = "data" + o.charAt(0).toUpperCase() + o.slice(1);
		} else {
			const o = t.slice(4);
			if (!Wa.test(o)) {
				let a = o.replace(Yf, Qf);
...
const Zf = bl([kl, $f, Cl, Al, Tl], "html"),
	_i = bl([kl, Gf, Cl, Al, Tl], "svg");
function e0(e) {
	return e.join(" ").trim();
}
var Ct = {},
...
`,
	...
	Pr = function (x, S) {
		...
		function b(T) {
			...
			w = ~R ? T.length - R : w + T.length;
		}
		function N() {
			var T = { line: y, column: w };
			return function (P) {
				return (P.position = new L(T)), M(), P;
			};
		}
		function L(T) {
			(this.start = T),
				(this.end = { line: y, column: w }),
				(this.source = S.source);
		}
		L.prototype.content = x;
		function E(T) {
			var P = new Error(S.source + ":" + y + ":" + w + ": " + T);
			if (
				((P.reason = T),
				(P.filename = S.source),
				(P.line = y),
		...
		function I(T) {
			...
			if (P) {
				var R = P[0];
				return b(R), (x = x.slice(R.length)), P;
			}
		}
		function M() {
			I(n);
		...
		function k() {
			...
			if (!(u != x.charAt(0) || c != x.charAt(1))) {
				for (
					var P = 2;
					f != x.charAt(P) && (c != x.charAt(P) || u != x.charAt(P + 1));

				)
					++P;
				if (((P += 2), f === x.charAt(P - 1)))
					return E("End of comment missing");
				var R = x.slice(2, P - 2);
				return (
					(w += 2), b(R), (x = x.slice(P)), (w += 2), T({ type: d, comment: R })
				);
			}
		}
		function C() {
			var T = N(),
				P = I(r);
			if (P) {
				if ((k(), !I(i))) return E("property missing ':'");
				var R = I(o),
					q = T({
						type: h,
						property: m(P[0].replace(e, f)),
						value: R ? m(R[0].replace(e, f)) : f,
					});
				return I(a), q;
			}
		}
		function A() {
			var T = [];
			z(T);
			for (var P; (P = C()); ) P !== !1 && (T.push(P), z(T));
			return T;
		}
		return M(), A();
	};
	function m(x) {
		return x ? x.replace(l, f) : f;
	}
	return Pr;
}
var Ga;
function n0() {
	...
	Object.defineProperty(Ct, "__esModule", { value: !0 }), (Ct.default = n);
	var t = e(t0());
	function n(r, i) {
		var o = null;
		...
		s = function (u, c) {
			return (
				...
				o(u)
					? u
					: ((u = u.toLowerCase()),
						c.reactCompat ? (u = u.replace(i, l)) : (u = u.replace(r, l)),
						u.replace(t, a))
			);
		};
	return (qt.camelCase = s), qt;
}
var Yt, Ya;
function i0() {
	if (Ya) return Yt;
	...
	function r(i, o) {
		...
		return (
			!i ||
				typeof i != "string" ||
				(0, t.default)(i, function (l, s) {
					l && s && (a[(0, n.camelCase)(l, o)] = s);
				}),
			a
		);
	}
...
const Mi = {}.hasOwnProperty,
	s0 = new Map(),
	u0 = /[A-Z]/g,
	c0 = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
	f0 = new Set(["td", "th"]),
	Ll = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
function h0(e, t) {
...
function Pl(e, t, n) {
	if (t.type === "element") return d0(e, t, n);
	if (t.type === "mdxFlowExpression" || t.type === "mdxTextExpression")
		return m0(e, t);
	if (t.type === "mdxJsxFlowElement" || t.type === "mdxJsxTextElement")
		return g0(e, t, n);
	if (t.type === "mdxjsEsm") return p0(e, t);
	if (t.type === "root") return x0(e, t, n);
	if (t.type === "text") return y0(e, t);
}
function d0(e, t, n) {
	const r = e.schema;
	let i = r;
	t.tagName.toLowerCase() === "svg" &&
		...
		((i = _i), (e.schema = i)),
		e.ancestors.push(t);
	const o = _l(e, t.tagName, !1),
		a = b0(e, t);
	let l = Ri(e, t);
	return (
		c0.has(t.tagName) &&
			(l = l.filter(function (s) {
				return typeof s == "string" ? !Uf(s) : !0;
			})),
		Nl(e, a, o, t),
		zi(a, l),
		e.ancestors.pop(),
...
function g0(e, t, n) {
	const r = e.schema;
	let i = r;
	t.name === "svg" && r.space === "html" && ((i = _i), (e.schema = i)),
		e.ancestors.push(t);
	const o = t.name === null ? e.Fragment : _l(e, t.name, !0),
		a = k0(e, t),
		l = Ri(e, t);
	return (
		Nl(e, a, o, t),
...
function x0(e, t, n) {
	const r = {};
	return zi(r, Ri(e, t)), e.create(t, e.Fragment, r, n);
}
function y0(e, t) {
	return t.value;
}
...
function b0(e, t) {
	...
	for (i in t.properties)
		if (i !== "children" && Mi.call(t.properties, i)) {
			const o = S0(e, i, t.properties[i]);
			if (o) {
				const [a, l] = o;
...
function S0(e, t, n) {
	...
	if (!(n == null || (typeof n == "number" && Number.isNaN(n)))) {
		if (
			(Array.isArray(n) && (n = r.commaSeparated ? Ff(n) : e0(n)),
			r.property === "style")
		) {
			let i = typeof n == "object" ? n : E0(e, String(n));
			return e.stylePropertyNameCase === "css" && (i = C0(i)), ["style", i];
		}
		return [
			e.elementAttributeNameCase === "react" && r.space
				? qf[r.property] || r.property
				: r.attribute,
			n,
		];
	}
...
function E0(e, t) {
	try {
		...
		throw (
			...
			(i.url = Ll + "#cannot-parse-style-attribute"),
			i)
		);
	}
}
function _l(e, t, n) {
	...
	if (r.type === "Literal") {
		const i = r.value;
		return Mi.call(e.components, i) ? e.components[i] : i;
	}
	if (e.evaluater) return e.evaluater.evaluateExpression(r);
	sn(e);
}
function sn(e, t) {
	const n = new ve("Cannot handle MDX estrees without `createEvaluater`", {
		ancestors: e.ancestors,
		place: t,
		ruleId: "mdx-estree",
		source: "hast-util-to-jsx-runtime",
	...
	throw (
		...
		(n.url = Ll + "#cannot-handle-mdx-estrees-without-createevaluater"),
		n)
	);
}
function C0(e) {
	const t = {};
	let n;
	for (n in e) Mi.call(e, n) && (t[A0(n)] = e[n]);
	return t;
}
function A0(e) {
	let t = e.replace(u0, T0);
...
function L0(e, t) {
	let n;
	for (n in t) {
		const i = (Za.call(e, n) ? e[n] : void 0) || (e[n] = {}),
			o = t[n];
		let a;
		if (o)
			for (a in o) {
...
const cr = st(new RegExp("\\p{P}|\\p{S}", "u")),
	xt = st(/\s/);
function st(e) {
	return t;
	function t(n) {
...
function Bt(e) {
	...
	for (; ++n < e.length; ) {
		...
		let a = "";
		if (o === 37 && xe(e.charCodeAt(n + 1)) && xe(e.charCodeAt(n + 2))) i = 2;
		else if (o < 128)
...
function te(e, t, n, r) {
	...
	function l(s) {
		return Z(s) && o++ < i ? (e.consume(s), l) : (e.exit(n), t(s));
	}
}
const M0 = { tokenize: z0 };
function z0(e) {
...
function F0(e) {
	...
	function l(b) {
		if (r < n.length) {
			const N = n[r];
			return (t.containerState = N[1]), e.attempt(N[0].continuation, s, u)(b);
		}
		return u(b);
	}
	function s(b) {
		if ((r++, t.containerState._closeFlow)) {
			...
			y(r);
			let I = N;
			for (; I < t.events.length; ) (t.events[I][1].end = { ...E }), I++;
			return (
				Te(t.events, L + 1, 0, t.events.slice(N)), (t.events.length = I), u(b)
			);
		}
		return l(b);
	}
	function u(b) {
		...
		return (t.containerState = {}), e.check(eo, c, f)(b);
	}
	function c(b) {
		return i && w(), y(r), d(b);
	}
	function f(b) {
		return (
			(t.parser.lazy[t.now().line] = r !== n.length), (a = t.now().offset), m(b)
		);
	}
	function d(b) {
		return (t.containerState = {}), e.attempt(eo, h, m)(b);
	}
	function h(b) {
	...
	function x(b) {
		if (b === null) {
			S(e.exit("chunkFlow"), !0), y(0), e.consume(b);
			return;
		}
		return U(b)
			? (e.consume(b),
	...
	function S(b, N) {
		...
		if (
			...
			for (; E--; )
				if (
					i.events[E][1].start.offset < a &&
					(!i.events[E][1].end || i.events[E][1].end.offset > a)
				)
					return;
			...
			for (y(r), E = I; E < t.events.length; )
				(t.events[E][1].end = { ...k }), E++;
			Te(t.events, M + 1, 0, t.events.slice(I)), (t.events.length = E);
		}
	}
	function y(b) {
		let N = n.length;
...
const fi = { name: "attention", resolveAll: B0, tokenize: V0 };
function B0(e, t) {
	let n = -1,
		r,
		i,
			...
			for (r = n; r--; )
				if (
					...
					to(f, -s),
						...
						(u = Ie(
							u,
							fr(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t),
						)),
						(u = Ie(u, [
							["exit", o, t],
							["enter", l, t],
...
const H0 = { name: "autolink", tokenize: U0 };
function U0(e, t, n) {
	let r = 0;
	return i;
	function i(h) {
	...
	function o(h) {
		return we(h) ? (e.consume(h), a) : h === 64 ? n(h) : u(h);
	}
	function a(h) {
		return h === 43 || h === 45 || h === 46 || xe(h) ? ((r = 1), l(h)) : u(h);
	}
	function l(h) {
		return h === 58
			? (e.consume(h), (r = 0), s)
			: (h === 43 || h === 45 || h === 46 || xe(h)) && r++ < 32
				? (e.consume(h), l)
				: ((r = 0), u(h));
	}
	function s(h) {
		return h === 62
			? (e.exit("autolinkProtocol"),
				...
				e.exit("autolink"),
				t)
			: h === null || h === 32 || h === 60 || Zn(h)
				? n(h)
				: (e.consume(h), s);
	}
	function u(h) {
		return h === 64 ? (e.consume(h), c) : N0(h) ? (e.consume(h), u) : n(h);
	}
	function c(h) {
		return xe(h) ? f(h) : n(h);
	}
...
const vn = { partial: !0, tokenize: W0 };
function W0(e, t, n) {
	return r;
	function r(o) {
...
function G0(e, t, n) {
	...
	function o(a) {
		return e.attempt(Rl, t, n)(a);
	}
}
function q0(e) {
	e.exit("blockQuote");
}
const Fl = { name: "characterEscape", tokenize: Y0 };
function Y0(e, t, n) {
	return r;
	function r(o) {
		return (
...
const jl = { name: "characterReference", tokenize: K0 };
function K0(e, t, n) {
	const r = this;
	let i = 0,
		o,
	...
	function s(f) {
		return f === 35
			? (e.enter("characterReferenceMarkerNumeric"),
				...
				u)
			: (e.enter("characterReferenceValue"), (o = 31), (a = xe), c(f));
	}
	function u(f) {
		return f === 88 || f === 120
			? (e.enter("characterReferenceMarkerHexadecimal"),
				...
				(a = _0),
				c)
			: (e.enter("characterReferenceValue"), (o = 7), (a = ci), c(f));
	}
	function c(f) {
		if (f === 59 && i) {
			const d = e.exit("characterReferenceValue");
			return a === xe && !ji(r.sliceSerialize(d))
				? n(f)
				: (e.enter("characterReferenceMarker"),
					e.consume(f),
					e.exit("characterReferenceMarker"),
...
const no = { partial: !0, tokenize: Q0 },
	ro = { concrete: !0, name: "codeFenced", tokenize: X0 };
function X0(e, t, n) {
	const r = this,
		i = { partial: !0, tokenize: L };
	let o = 0,
		a = 0,
		l;
	return s;
		...
		return E === l
			...
			: a < 3
				...
				: (e.exit("codeFencedFenceSequence"),
					Z(E) ? te(e, f, "whitespace")(E) : f(E));
	}
	function f(E) {
		return E === null || U(E)
			? (e.exit("codeFencedFence"), r.interrupt ? t(E) : e.check(no, x, N)(E))
	...
	function y(E) {
		return o > 0 && Z(E) ? te(e, w, "linePrefix", o + 1)(E) : w(E);
	}
	function w(E) {
		return E === null || U(E)
			? e.check(no, x, N)(E)
			: (e.enter("codeFlowValue"), b(E));
	}
	function b(E) {
		return E === null || U(E)
			? (e.exit("codeFlowValue"), w(E))
			: (e.consume(E), b);
	}
	function N(E) {
	...
	function L(E, I, M) {
		...
		function A(R) {
			return R === l ? (E.enter("codeFencedFenceSequence"), T(R)) : M(R);
		}
		function T(R) {
			return R === l
				? (z++, E.consume(R), T)
				: z >= a
					? (E.exit("codeFencedFenceSequence"),
						Z(R) ? te(E, P, "whitespace")(R) : P(R))
					: M(R);
		}
		function P(R) {
			return R === null || U(R) ? (E.exit("codeFencedFence"), I(R)) : M(R);
		}
	}
}
function Q0(e, t, n) {
...
const _r = { name: "codeIndented", tokenize: Z0 },
	J0 = { partial: !0, tokenize: eh };
function Z0(e, t, n) {
	const r = this;
	return i;
	function i(u) {
		return e.enter("codeIndented"), te(e, o, "linePrefix", 5)(u);
	}
	function o(u) {
...
const th = { name: "codeText", previous: rh, resolve: nh, tokenize: ih };
function nh(e) {
	let t = e.length - 4,
		n = 3,
		r,
...
function Bl(e) {
	...
	for (; ++n < c.length; ) {
		...
		if (r[0] === "enter")
			r[1].contentType && (Object.assign(t, oh(c, n)), (n = t[n]), (u = !0));
	...
	return Te(e, 0, Number.POSITIVE_INFINITY, c.slice(0)), !u;
}
function oh(e, t) {
	const n = e.get(t)[1],
		r = e.get(t)[2];
	...
	for (
		...
		const y = l.slice(S[d], S[d + 1]),
			w = o.pop();
		s.push([w, w + y.length - 1]), e.splice(w, 2, y);
	}
	for (s.reverse(), d = -1; ++d < s.length; )
		(u[m + s[d][0]] = m + s[d][1]), (m += s[d][1] - s[d][0] - 1);
	return u;
}
const lh = { resolve: uh, tokenize: ch },
	sh = { partial: !0, tokenize: fh };
function uh(e) {
	return Bl(e), e;
}
function ch(e, t) {
	...
	function i(l) {
		return l === null ? o(l) : U(l) ? e.check(sh, a, o)(l) : (e.consume(l), i);
	}
	function o(l) {
...
function Vl(e, t, n, r, i, o, a, l, s) {
	...
	function f(y) {
		return y === 60
			? (e.enter(r), e.enter(i), e.enter(o), e.consume(y), e.exit(o), d)
			: y === null || y === 32 || y === 41 || Zn(y)
				? n(y)
				: (e.enter(r),
					e.enter(a),
					e.enter(l),
	...
	function h(y) {
		return y === 62
			? (e.exit("chunkString"), e.exit(l), d(y))
			: y === null || y === 60 || U(y)
				? n(y)
				: (e.consume(y), y === 92 ? m : h);
	}
	function m(y) {
		return y === 60 || y === 62 || y === 92 ? (e.consume(y), h) : h(y);
	}
	function x(y) {
		return !c && (y === null || y === 41 || le(y))
			? (e.exit("chunkString"), e.exit(l), e.exit(a), e.exit(r), t(y))
			: c < u && y === 40
				? (e.consume(y), c++, x)
				: y === 41
					? (e.consume(y), c--, x)
					: y === null || y === 32 || y === 40 || Zn(y)
						? n(y)
						: (e.consume(y), y === 92 ? S : x);
	}
	function S(y) {
...
const hh = { name: "definition", tokenize: mh },
	dh = { partial: !0, tokenize: ph };
function mh(e, t, n) {
	const r = this;
	let i;
	return o;
	...
	function c(h) {
		return e.attempt(dh, f, f)(h);
	}
	function f(h) {
		return Z(h) ? te(e, d, "whitespace")(h) : d(h);
	}
	function d(h) {
		return h === null || U(h)
...
function ph(e, t, n) {
	...
	function o(l) {
		return Z(l) ? te(e, a, "whitespace")(l) : a(l);
	}
	function a(l) {
		return l === null || U(l) ? t(l) : n(l);
	}
}
const gh = { name: "hardBreakEscape", tokenize: xh };
function xh(e, t, n) {
	return r;
	function r(o) {
...
const yh = { name: "headingAtx", resolve: vh, tokenize: wh };
function vh(e, t) {
	let n = e.length - 2,
		r = 3,
		i,
...
const bh = [
	...
	io = ["pre", "script", "style", "textarea"],
	kh = { concrete: !0, name: "htmlFlow", resolveTo: Ch, tokenize: Ah },
	Sh = { partial: !0, tokenize: Ih },
	Eh = { partial: !0, tokenize: Th };
function Ch(e) {
	let t = e.length;
...
function Ah(e, t, n) {
	...
	function f(v) {
		return v === 33
			...
			: v === 47
				? (e.consume(v), (o = !0), x)
				: v === 63
					? (e.consume(v), (i = 3), r.interrupt ? t : p)
					: we(v)
						? (e.consume(v), (a = String.fromCharCode(v)), S)
						: n(v);
	}
	function d(v) {
		return v === 45
			...
			: v === 91
				...
				: we(v)
					? (e.consume(v), (i = 4), r.interrupt ? t : p)
					: n(v);
	}
	function h(v) {
	...
	function m(v) {
		const re = "CDATA[";
		return v === re.charCodeAt(l++)
			? (e.consume(v), l === re.length ? (r.interrupt ? t : A) : m)
			: n(v);
	}
	function x(v) {
		return we(v) ? (e.consume(v), (a = String.fromCharCode(v)), S) : n(v);
	}
	function S(v) {
		if (v === null || v === 47 || v === 62 || le(v)) {
			const re = v === 47,
				he = a.toLowerCase();
			return !re && !o && io.includes(he)
				? ((i = 1), r.interrupt ? t(v) : A(v))
				: bh.includes(a.toLowerCase())
					? ((i = 6), re ? (e.consume(v), y) : r.interrupt ? t(v) : A(v))
					: ((i = 7),
	...
	function L(v) {
		return v === 61 ? (e.consume(v), E) : Z(v) ? (e.consume(v), L) : b(v);
	}
	function E(v) {
	...
	function z(v) {
		return v === 47 || v === 62 || Z(v) ? b(v) : n(v);
	}
	function k(v) {
		return v === 62 ? (e.consume(v), C) : n(v);
	}
	function C(v) {
		return v === null || U(v) ? A(v) : Z(v) ? (e.consume(v), C) : n(v);
	}
	function A(v) {
		return v === 45 && i === 2
			? (e.consume(v), q)
				...
				: v === 62 && i === 4
					...
					: v === 63 && i === 3
						...
						: v === 93 && i === 5
							? (e.consume(v), V)
							: U(v) && (i === 6 || i === 7)
								? (e.exit("htmlFlowData"), e.check(Sh, $, T)(v))
								: v === null || U(v)
									? (e.exit("htmlFlowData"), T(v))
									: (e.consume(v), A);
	}
	function T(v) {
		return e.check(Eh, P, $)(v);
	}
	function P(v) {
		return e.enter("lineEnding"), e.consume(v), e.exit("lineEnding"), R;
	}
	function R(v) {
		return v === null || U(v) ? T(v) : (e.enter("htmlFlowData"), A(v));
	}
	function q(v) {
		return v === 45 ? (e.consume(v), p) : A(v);
	}
	function W(v) {
		return v === 47 ? (e.consume(v), (a = ""), B) : A(v);
	}
	function B(v) {
		if (v === 62) {
			const re = a.toLowerCase();
			return io.includes(re) ? (e.consume(v), j) : A(v);
		}
		return we(v) && a.length < 8
			? (e.consume(v), (a += String.fromCharCode(v)), B)
			: A(v);
	}
	function V(v) {
		return v === 93 ? (e.consume(v), p) : A(v);
	}
	function p(v) {
		return v === 62
			? (e.consume(v), j)
...
const Dh = { name: "htmlText", tokenize: Lh };
function Lh(e, t, n) {
	const r = this;
	let i, o, a;
	return l;
	...
	function h(p) {
		return p === 62 ? q(p) : p === 45 ? d(p) : f(p);
	}
	function m(p) {
		const j = "CDATA[";
		return p === j.charCodeAt(o++)
			? (e.consume(p), o === j.length ? x : m)
			: n(p);
	}
	function x(p) {
		return p === null
	...
	function y(p) {
		return p === 62 ? q(p) : p === 93 ? (e.consume(p), y) : x(p);
	}
	function w(p) {
		return p === null || p === 62
			? q(p)
	...
	function L(p) {
		return we(p) ? (e.consume(p), E) : n(p);
	}
	function E(p) {
		return p === 45 || xe(p) ? (e.consume(p), E) : I(p);
	}
	function I(p) {
		return U(p) ? ((a = I), W(p)) : Z(p) ? (e.consume(p), I) : q(p);
	}
	function M(p) {
		return p === 45 || xe(p)
			? (e.consume(p), M)
	...
	function k(p) {
		return p === 45 || p === 46 || p === 58 || p === 95 || xe(p)
			? (e.consume(p), k)
			: C(p);
	}
	function C(p) {
	...
	function R(p) {
		return p === 47 || p === 62 || le(p) ? z(p) : n(p);
	}
	function q(p) {
		return p === 62
			? (e.consume(p), e.exit("htmlTextData"), e.exit("htmlText"), t)
			: n(p);
	}
	function W(p) {
		return (
	...
	function V(p) {
		return e.enter("htmlTextData"), a(p);
	}
}
const Bi = { name: "labelEnd", resolveAll: Oh, resolveTo: Mh, tokenize: zh },
	Ph = { tokenize: Rh },
	Nh = { tokenize: Fh },
	_h = { tokenize: jh };
function Oh(e) {
...
function Mh(e, t) {
	...
	return (
		...
		(l = Ie(l, e.slice(o + 1, o + r + 3))),
		(l = Ie(l, [["enter", c, t]])),
		(l = Ie(
			l,
			fr(t.parser.constructs.insideSpan.null, e.slice(o + r + 4, a - 3), t),
		)),
		(l = Ie(l, [["exit", c, t], e[a - 2], e[a - 1], ["exit", u, t]])),
		(l = Ie(l, e.slice(a + 1))),
		(l = Ie(l, [["exit", s, t]])),
		Te(e, o, e.length, l),
		e
...
function zh(e, t, n) {
		...
		return o
			? o._inactive
				...
				: ((a = r.parser.defined.includes(
						Me(r.sliceSerialize({ start: o.end, end: r.now() })),
					)),
					e.enter("labelEnd"),
					e.enter("labelMarker"),
					e.consume(d),
	...
	function s(d) {
		return d === 40
			? e.attempt(Ph, c, a ? c : f)(d)
			: d === 91
				? e.attempt(Nh, c, a ? u : f)(d)
				: a
					? c(d)
					: f(d);
	}
	function u(d) {
		return e.attempt(_h, c, f)(d);
	}
	function c(d) {
		return t(d);
	}
...
const Bh = { name: "labelStartImage", resolveAll: Bi.resolveAll, tokenize: Vh };
function Vh(e, t, n) {
	const r = this;
	return i;
	function i(l) {
...
const Hh = { name: "labelStartLink", resolveAll: Bi.resolveAll, tokenize: Uh };
function Uh(e, t, n) {
	const r = this;
	return i;
	function i(a) {
...
const Or = { name: "lineEnding", tokenize: Wh };
function Wh(e, t) {
	return n;
	function n(r) {
		return (
	...
	function s(u) {
		return u === i
			...
			: (e.exit("thematicBreakSequence"),
				Z(u) ? te(e, l, "whitespace")(u) : l(u));
	}
}
const ke = {
		continuation: { tokenize: Kh },
		exit: Qh,
		name: "list",
		tokenize: Yh,
	},
	Gh = { partial: !0, tokenize: Jh },
	qh = { partial: !0, tokenize: Xh };
function Yh(e, t, n) {
	const r = this,
		...
		if (
			...
			if (
				...
				return (
					...
					h === 42 || h === 45 ? e.check(Un, n, u)(h) : u(h)
				);
			if (!r.interrupt || h === 49)
	...
	function u(h) {
		return (
			...
			e.check(vn, r.interrupt ? n : c, e.attempt(Gh, d, f))
		);
	}
	function c(h) {
...
function Kh(e, t, n) {
	...
	function i(l) {
		return (
			...
			te(e, t, "listItemIndent", r.containerState.size + 1)(l)
		);
	}
	function o(l) {
...
function Jh(e, t, n) {
	...
	function i(o) {
		const a = r.events[r.events.length - 1];
		return !Z(o) && a && a[1].type === "listItemPrefixWhitespace" ? t(o) : n(o);
	}
}
const ao = { name: "setextUnderline", resolveTo: Zh, tokenize: e2 };
function Zh(e, t) {
	let n = e.length,
		r,
		i,
	...
	const t = this,
		n = e.attempt(
			...
			e.attempt(
				...
				te(
					e,
					e.attempt(this.parser.constructs.flow, i, e.attempt(lh, i)),
					"linePrefix",
				),
			),
		);
...
const r2 = { resolveAll: $l() },
	i2 = Wl("string"),
	a2 = Wl("text");
function Wl(e) {
	return { resolveAll: $l(e === "text" ? o2 : void 0), tokenize: t };
	function t(n) {
		const r = this,
...
function x2(e, t, n) {
	...
	function f(C) {
		return (
			...
			a[a.length - 1] !== null
				? []
				: (M(t, 0), (u.events = fr(o, u.events, u)), u.events)
		);
	}
	function d(C, A) {
		return v2(h(C), A);
	...
	function m() {
		const { _bufferIndex: C, _index: A, line: T, column: P, offset: R } = r;
		return { _bufferIndex: C, _index: A, line: T, column: P, offset: R };
	}
	function x(C) {
		(i[C.line] = C.column), k();
	}
		...
		for (; r._index < a.length; ) {
			...
			if (typeof A == "string")
				for (
					...
					r._index === C && r._bufferIndex < A.length;
	...
	function w(C) {
		U(C)
			? (r.line++, (r.column = 1), (r.offset += C === -3 ? 2 : 1), k())
	...
	function N(C) {
		const A = l.pop();
		return (A.end = m()), u.events.push(["exit", A, u]), A;
	}
	function L(C, A) {
		M(C, A.from);
	}
	...
	function I(C, A) {
		...
		function T(P, R, q) {
			let W, B, V, p;
			return Array.isArray(P) ? $(P) : "tokenize" in P ? $([P]) : j(P);
			function j(_) {
				return J;
				function J(ie) {
					const ne = ie !== null && _[ie],
						de = ie !== null && _.null,
						kt = [
			...
			function $(_) {
				return (W = _), (B = 0), _.length === 0 ? q : v(_[B]);
			}
			function v(_) {
				return J;
				function J(ie) {
					return (
						(p = z()),
						(V = _),
						_.partial || (u.currentConstruct = _),
						_.name && u.parser.constructs.disable.null.includes(_.name)
							? he()
							: _.tokenize.call(
			...
			function he(_) {
				return p.restore(), ++B < W.length ? v(W[B]) : q;
			}
		}
	}
	function M(C, A) {
		C.resolveAll && !o.includes(C) && o.push(C),
			C.resolve &&
				Te(u.events, A, u.events.length - A, C.resolve(u.events.slice(A), u)),
	...
	function z() {
		const C = m(),
			...
			P = u.events.length,
			R = Array.from(l);
		return { from: P, restore: q };
		function q() {
			(r = C),
				(u.previous = A),
				(u.currentConstruct = T),
				(u.events.length = P),
				(l = R),
				k();
		}
...
function k2() {
	...
	function i(o, a, l) {
		...
		for (
			...
			if (h === 10 && f === d && r) s.push(-3), (r = void 0);
			else
				switch (
					(r && (s.push(-5), (r = void 0)),
...
function C2(e, t, n) {
	...
	if (n.charCodeAt(0) === 35) {
		const i = n.charCodeAt(1),
			o = i === 120 || i === 88;
		return zl(n.slice(o ? 2 : 1), o ? 16 : 10);
	}
	return ji(n) || e;
}
...
function T2(e) {
	const t = {
		...
		enter: {
			...
			emphasis: o(se),
			hardBreakEscape: o(et),
			hardBreakTrailing: o(et),
			htmlFlow: o(Pn, a),
			htmlFlowData: z,
			htmlText: o(Pn, a),
			htmlTextData: z,
	...
	function r(D) {
		...
		for (oe = -1; ++oe < D.length; ) {
			const Ne = t[D[oe][0]];
			Gl.call(Ne, D[oe][1].type) &&
				Ne[D[oe][1].type].call(
					Object.assign({ sliceSerialize: D[oe][2].sliceSerialize }, G),
					D[oe][1],
				);
		}
		if (G.tokenStack.length > 0) {
			const Ne = G.tokenStack[G.tokenStack.length - 1];
			(Ne[1] || lo).call(G, void 0, Ne[0]);
		}
		for (
			F.position = {
				start: nt(
	...
	function i(D, F, G) {
		...
		for (; ++ee <= G; ) {
			...
			switch (Ce[1].type) {
				...
				case "listOrdered":
				case "blockQuote": {
					Ce[0] === "enter" ? oe++ : oe--, ($t = void 0);
					break;
				}
				case "lineEndingBlank": {
					Ce[0] === "enter" &&
						(ht && !$t && !oe && !Wt && (Wt = ee), ($t = void 0));
					break;
				}
				case "linePrefix":
				case "listItemValue":
			...
			if (
				(!oe && Ce[0] === "enter" && Ce[1].type === "listItemPrefix") ||
				(oe === -1 &&
					Ce[0] === "exit" &&
				...
				if (ht) {
					...
					for ($e = void 0; St--; ) {
						...
						if (
							...
							$e && ((D[$e][1].type = "lineEndingBlank"), (Ne = !0)),
								(Ge[1].type = "lineEnding"),
								($e = St);
						} else if (
							!(
					...
					Wt && (!$e || Wt < $e) && (ht._spread = !0),
						(ht.end = Object.assign({}, $e ? D[$e][1].start : Ce[1].end)),
						D.splice($e || ee, 0, ["exit", ht, Ce[2]]),
						ee++,
						G++;
				}
		...
		return (D[F][1]._spread = Ne), G;
	}
	function o(D, F) {
		return G;
		function G(ee) {
			l.call(this, D(ee), ee), F && F.call(this, ee);
		}
	}
	function a() {
	...
	function l(D, F, G) {
		this.stack[this.stack.length - 1].children.push(D),
			this.stack.push(D),
			this.tokenStack.push([F, G || void 0]),
			(D.position = { start: nt(F.start), end: void 0 });
	}
	function s(D) {
		return F;
		function F(G) {
			D && D.call(this, G), u.call(this, G);
		}
	}
	function u(D, F) {
		...
		if (ee)
			ee[0].type !== D.type &&
				(F ? F.call(this, D, ee[0]) : (ee[1] || lo).call(this, D, ee[0]));
		else
			throw new Error(
				"Cannot close `" +
					D.type +
					"` (" +
					tn({ start: D.start, end: D.end }) +
					"): it’s not open",
			);
		G.position.end = nt(D.end);
	}
	function c() {
	...
	function d(D) {
		if (this.data.expectingFirstListItemValue) {
			...
			(F.start = Number.parseInt(this.sliceSerialize(D), 10)),
	...
	function w(D) {
		...
		(G.label = F), (G.identifier = Me(this.sliceSerialize(D)).toLowerCase());
	}
	function b() {
		const D = this.resume(),
			F = this.stack[this.stack.length - 1];
	...
	function L(D) {
		...
		if (!F.depth) {
			const G = this.sliceSerialize(D).length;
			F.depth = G;
		}
	}
	function E() {
	...
	function I(D) {
		const F = this.stack[this.stack.length - 1];
		F.depth = this.sliceSerialize(D).codePointAt(0) === 61 ? 1 : 2;
	}
	function M() {
	...
	function z(D) {
		...
		(!ee || ee.type !== "text") &&
			((ee = gu()),
			(ee.position = { start: nt(D.start), end: void 0 }),
			G.push(ee)),
			this.stack.push(ee);
	}
	function k(D) {
		const F = this.stack.pop();
		(F.value += this.sliceSerialize(D)), (F.position.end = nt(D.end));
	}
	function C(D) {
		const F = this.stack[this.stack.length - 1];
		if (this.data.atHardBreak) {
			const G = F.children[F.children.length - 1];
			(G.position.end = nt(D.end)), (this.data.atHardBreak = void 0);
			return;
		}
		!this.data.setextHeadingSlurpLineEnding &&
			t.canContainEols.includes(F.type) &&
			(z.call(this, D), k.call(this, D));
	}
	function A() {
	...
	function B(D) {
		const F = this.sliceSerialize(D),
			G = this.stack[this.stack.length - 2];
		(G.label = E2(F)), (G.identifier = Me(F).toLowerCase());
	}
	function V() {
		const D = this.stack[this.stack.length - 1],
			F = this.resume(),
	...
	function re(D) {
		const F = this.resume(),
			G = this.stack[this.stack.length - 1];
		(G.label = F),
			(G.identifier = Me(this.sliceSerialize(D)).toLowerCase()),
	...
	function _(D) {
		...
		let ee;
		G
			? ((ee = zl(F, G === "characterReferenceMarkerNumeric" ? 10 : 16)),
	...
	function J(D) {
		const F = this.stack.pop();
		F.position.end = nt(D.end);
	}
	function ie(D) {
		k.call(this, D);
		const F = this.stack[this.stack.length - 1];
		F.url = this.sliceSerialize(D);
	}
	function ne(D) {
		k.call(this, D);
		const F = this.stack[this.stack.length - 1];
		F.url = "mailto:" + this.sliceSerialize(D);
	}
	function de() {
...
function K2(e, t) {
	...
	if (n.length > 0) {
		const a = {
			...
			l = Oi(t.children[1]),
			s = Il(t.children[t.children.length - 1]);
...
function X2(e, t, n) {
	...
	for (; ++s < l; ) {
		...
		f && ((m.children = e.all(f)), e.patch(f, m), (m = e.applyData(f, m))),
			u.push(m);
	}
	const c = {
		type: "element",
...
function J2(e) {
	...
	const o = [];
	for (; r; )
		o.push(co(t.slice(i, r.index), i > 0, !0), r[0]),
			(i = r.index + r[0].length),
			(r = n.exec(t));
	return o.push(co(t.slice(i), i > 0, !1)), o.join("");
}
function co(e, t, n) {
	let r = 0,
		i = e.length;
	if (t) {
		...
		for (; o === so || o === uo; ) r++, (o = e.codePointAt(r));
	}
	if (n) {
		let o = e.codePointAt(i - 1);
		for (; o === so || o === uo; ) i--, (o = e.codePointAt(i - 1));
	}
	return i > r ? e.slice(r, i) : "";
}
function Z2(e, t) {
	const n = { type: "text", value: J2(String(t.value)) };
	return e.patch(t, n), e.applyData(t, n);
}
function ed(e, t) {
...
const Xl = -1,
	...
	Ql = 7,
	Jl = 8,
	fo = typeof self == "object" ? self : globalThis,
	nd = (e, t) => {
	...
	_n = ([e, t]) => e === hr && (t === "function" || t === "symbol"),
	ad = (e, t, n, r) => {
		const i = (a, l) => {
				const s = r.push(a) - 1;
				return n.set(l, s), s;
				...
				switch (l) {
						...
						if (s) {
							...
							return (
								s === "DataView"
									...
									: s === "ArrayBuffer" && (d = new Uint8Array(a)),
								i([s, [...d]], a)
							);
						}
						const c = [],
					...
					case Ui: {
						const c = [],
							f = i([l, c], a);
						for (const [d, h] of a)
							(e || !(_n(Xt(d)) || _n(Xt(h)))) && c.push([o(d), o(h)]);
						return f;
					}
					case Wi: {
						const c = [],
							f = i([l, c], a);
						for (const d of a) (e || !_n(Xt(d))) && c.push(o(d));
						return f;
					}
				}
				const { message: u } = a;
	...
	mo = (e, { json: t, lossy: n } = {}) => {
		const r = [];
		return ad(!(t || n), !!t, new Map(), r)(e), r;
	},
	tr =
		typeof structuredClone == "function"
			? (e, t) =>
					t && ("json" in t || "lossy" in t) ? ho(mo(e, t)) : structuredClone(e)
			: (e, t) => ho(mo(e, t));
function od(e, t) {
...
function sd(e) {
	const t =
			typeof e.options.clobberPrefix == "string"
				? e.options.clobberPrefix
				: "user-content-",
		n = e.options.footnoteBackContent || od,
		r = e.options.footnoteBackLabel || ld,
			...
			children: [
				{
					type: "element",
					tagName: o,
					properties: { ...tr(a), id: "footnote-label" },
...
const dr = function (e) {
	...
	if (typeof e == "object") return Array.isArray(e) ? ud(e) : cd(e);
...
function mr(e) {
	...
	function t(n, r, i) {
		return !!(
			dd(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0)
		);
	}
}
function hd() {
	...
	function l(s, u, c) {
		...
		function d() {
			...
			if ("children" in s && s.children) {
				const y = s;
				if (y.children && h[0] !== pd)
					for (
						x = (r ? y.children.length : -1) + a, S = c.concat(y);
						x > -1 && x < y.children.length;

					) {
						const w = y.children[x];
						if (((m = l(w, x, S)()), m[0] === hi)) return m;
						x = typeof m[1] == "number" ? m[1] : x + a;
					}
			}
			return h;
		}
...
function yd(e, t) {
	...
	function s(c, f) {
		const d = c.type,
			h = l.handlers[d];
		if (di.call(l.handlers, d) && h) return h(l, c, f);
		if (l.options.passThrough && l.options.passThrough.includes(d)) {
			if ("children" in c) {
				const { children: x, ...S } = c,
					y = tr(S);
				return (y.children = l.all(c)), y;
			}
			return tr(c);
		}
		return (l.options.unknownHandler || bd)(l, c, f);
	}
	function u(c) {
		const f = [];
		if ("children" in c) {
			...
			for (; ++h < d.length; ) {
				...
				if (m) {
					if (
						h &&
						d[h - 1].type === "break" &&
						(!Array.isArray(m) && m.type === "text" && (m.value = po(m.value)),
						!Array.isArray(m) && m.type === "element")
					) {
						const x = m.children[0];
						x && x.type === "text" && (x.value = po(x.value));
					}
...
function wd(e, t) {
	...
	if (e && e.data) {
		...
		n.type === "element" && o && Object.assign(n.properties, tr(o)),
			"children" in n &&
				n.children &&
				i !== null &&
				i !== void 0 &&
...
function bd(e, t) {
	const n = t.data || {},
		r =
			"value" in t && !(di.call(n, "hProperties") || di.call(n, "hChildren"))
...
function Sd(e, t) {
	return e && "run" in e
		? async function (n, r) {
				const i = go(n, { file: r, ...t });
				await e.run(i, r);
			}
		: function (n, r) {
				return go(n, { file: r, ...(e || t) });
			};
}
function xo(e) {
	if (e) throw e;
	...
	return (
		(Mr = function s() {
			var u,
				...
				w = !1;
			for (
				typeof x == "boolean" && ((w = x), (x = arguments[1] || {}), (S = 2)),
							...
							x !== d &&
								(w && d && (o(d) || (h = i(d)))
									? (h
											? ((h = !1), (m = f && i(f) ? f : []))
											: (m = f && o(f) ? f : {}),
										a(x, { name: c, newValue: s(w, m, d) }))
									: typeof d < "u" && a(x, { name: c, newValue: d }));
			return x;
		}),
		Mr
	);
...
const je = { basename: Id, dirname: Dd, extname: Ld, join: Pd, sep: "/" };
function Id(e, t) {
...
class ts {
	constructor(t) {
		...
		t
			? pi(t)
				? (n = { path: t })
				: typeof t == "string" || Fd(t)
					? (n = { value: t })
					: (n = t)
			: (n = {}),
			(this.cwd = "cwd" in n ? "" : Od.cwd()),
			(this.data = {}),
			(this.history = []),
			(this.messages = []),
			this.value,
		...
		let i;
		for (i in n) Rr.includes(i) || (this[i] = n[i]);
	}
	get basename() {
	...
	set dirname(t) {
		vo(this.basename, "dirname"), (this.path = je.join(t || "", this.basename));
	}
	get extname() {
		return typeof this.path == "string" ? je.extname(this.path) : void 0;
	}
	set extname(t) {
		if ((Fr(t, "extname"), vo(this.dirname, "extname"), t)) {
	...
	set stem(t) {
		jr(t, "stem"),
			Fr(t, "stem"),
			(this.path = je.join(this.dirname || "", t + (this.extname || "")));
	}
	fail(t, n, r) {
...
class Gi extends jd {
	...
	data(t, n) {
		return typeof t == "string"
			? arguments.length === 2
				? (Hr("data", this.frozen), (this.namespace[t] = n), this)
				: (Bd.call(this.namespace, t) && this.namespace[t]) || void 0
			: t
	...
	parse(t) {
		...
		return Br("parse", r), r(String(n), n);
	}
	process(t, n) {
		const r = this;
		return (
			this.freeze(),
			Br("process", this.parser || this.Parser),
			Vr("process", this.compiler || this.Compiler),
		...
		function i(o, a) {
			...
			r.run(s, l, function (c, f, d) {
				...
				const h = f,
					m = r.stringify(h, d);
				Ud(m) ? (d.value = m) : (d.result = m), u(c, d);
			});
			function u(c, f) {
	...
	processSync(t) {
		...
		return (
			this.freeze(),
			Br("processSync", this.parser || this.Parser),
			Vr("processSync", this.compiler || this.Compiler),
			this.process(t, i),
			bo("processSync", "process", n),
			r
		);
		function i(o, a) {
			(n = !0), xo(o), (r = a);
	...
	runSync(t, n) {
		let r = !1,
			i;
		return this.run(t, n, o), bo("runSync", "run", r), i;
		function o(a, l) {
			xo(a), (i = l), (r = !0);
		}
	}
	stringify(t, n) {
		...
		return Vr("stringify", i), wo(t), i(t, r);
	}
	use(t, ...n) {
		...
		function a(u) {
			...
			l(u.plugins), u.settings && (i.settings = zr(!0, i.settings, u.settings));
		}
		function l(u) {
			let c = -1;
			if (u != null)
		...
		function s(u, c) {
			...
			if (d === -1) r.push([u, ...c]);
				...
				let [h, ...m] = c;
				const x = r[d][1];
				mi(x) && mi(h) && (h = zr(!0, x, h)), (r[d] = [u, h, ...m]);
			}
		}
	}
}
const Vd = new Gi().freeze();
function Br(e, t) {
...
const $d = "https://github.com/remarkjs/react-markdown/blob/main/changelog.md",
	ko = [],
	So = { allowDangerousHtml: !0 },
	Gd = /^(https?|ircs?|mailto|xmpp)$/i,
	qd = [
...
function Kd(e) {
	const t = e.rehypePlugins || ko,
		n = e.remarkPlugins || ko,
		r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...So } : So;
	return Vd().use(D2).use(n).use(Sd, r).use(t);
}
function Xd(e) {
	const t = e.children || "",
		n = new ts();
...
function Qd(e, t) {
	...
	function u(c, f, d) {
		...
		if (c.type === "element") {
			let h;
			for (h in Nr)
				if (Object.hasOwn(Nr, h) && Object.hasOwn(c.properties, h)) {
					const m = c.properties[h],
						x = Nr[h];
					(x === null || x.includes(c.tagName)) &&
						(c.properties[h] = s(String(m || ""), h, c));
				}
		}
		if (c.type === "element") {
			let h = n ? !n.includes(c.tagName) : o ? o.includes(c.tagName) : !1;
			if (
				(!h && r && typeof f == "number" && (h = !r(c, f, d)),
				h && d && typeof f == "number")
			)
				return (
					l && c.children
...
function em(e, t, n) {
	...
	function l(u, c) {
		...
		for (; ++f < c.length; ) {
			...
			if (i(h, m ? m.indexOf(h) : void 0, d)) return;
			d = h;
		}
		if (d) return s(u, c);
	}
	function s(u, c) {
		...
		let y = !1,
			w = [];
		d.lastIndex = 0;
		let b = d.exec(u.value);
		for (; b; ) {
			const N = b.index,
				L = { index: b.index, input: b.input, stack: [...c, u] };
			let E = h(...b, L);
			if (
				(typeof E == "string" &&
					(E = E.length > 0 ? { type: "text", value: E } : void 0),
				E === !1
					? (d.lastIndex = N + 1)
					: (m !== N && w.push({ type: "text", value: u.value.slice(m, N) }),
						Array.isArray(E) ? w.push(...E) : E && w.push(E),
						(m = N + b[0].length),
						(y = !0)),
				!d.global)
			)
		...
		return (
			y
				? (m < u.value.length &&
						w.push({ type: "text", value: u.value.slice(m) }),
					f.children.splice(S, 1, ...w))
				: (w = [u]),
			S + w.length
		);
	}
...
function tm(e) {
	...
	for (; ++r < n.length; ) {
		const i = n[r];
		t.push([nm(i[0]), rm(i[1])]);
	}
	return t;
}
function nm(e) {
	return typeof e == "string" ? new RegExp(Zd(e), "g") : e;
}
function rm(e) {
	return typeof e == "function"
		? e
...
function hm(e, t, n, r, i) {
	...
	if (
		!ns(i) ||
		(/^w/i.test(t) && ((n = t + n), (t = ""), (o = "http://")), !mm(n))
	)
		return !1;
	const a = pm(n + r);
	if (!a[0]) return !1;
...
function ns(e, t) {
	...
	return (e.index === 0 || xt(n) || cr(n)) && (!t || n !== 47);
}
rs.peek = Em;
function gm() {
	this.buffer();
...
function wm(e) {
	...
	n.type,
		(n.identifier = Me(this.sliceSerialize(e)).toLowerCase()),
		(n.label = t);
}
function bm(e) {
	this.exit(e);
...
function Am(e) {
	...
	return (
		...
		{
			handlers: { footnoteDefinition: n, footnoteReference: rs },
			unsafe: [
	...
	function n(r, i, o, a) {
		...
		const u = o.enter("footnoteDefinition"),
			c = o.enter("label");
		return (
			(s += l.move(o.safe(o.associationId(r), { before: s, after: "]" }))),
			c(),
			(s += l.move("]:")),
			r.children &&
				r.children.length > 0 &&
...
`
						: " ") +
						o.indentLines(o.containerFlow(r, l.current()), t ? is : Tm),
				))),
			u(),
			s
		);
...
function Lm() {
	return {
		unsafe: [{ character: "~", inConstruct: "phrasing", notInConstruct: Im }],
		handlers: { delete: as },
	};
}
function Pm(e) {
...
function Mm(e, t) {
	...
	let f = -1;
	if (typeof r == "object" && "length" in r) for (; ++f < u; ) o[f] = Co(r[f]);
	else {
		const x = Co(r);
		for (; ++f < u; ) o[f] = x;
	}
	...
	for (; ++f < u; ) {
		...
		x === 99
			...
			: x === 108
				...
				: x === 114 && (y = ":");
		let w =
			n.alignDelimiters === !1 ? 1 : Math.max(1, s[f] - S.length - y.length);
		const b = S + "-".repeat(w) + y;
		n.alignDelimiters !== !1 &&
			((w = S.length + w + y.length), w > s[f] && (s[f] = w), (h[f] = w)),
			(d[f] = b);
	}
	a.splice(1, 0, d), l.splice(1, 0, h), (c = -1);
	const m = [];
	for (; ++c < a.length; ) {
		const x = a[c],
			S = l[c];
		...
		for (; ++f < u; ) {
			...
			if (n.alignDelimiters !== !1) {
				...
				E === 114
					...
					: E === 99
						? L % 2
							? ((b = " ".repeat(L / 2 + 0.5)), (N = " ".repeat(L / 2 - 0.5)))
							: ((b = " ".repeat(L / 2)), (N = b))
						: (N = " ".repeat(L));
			}
			n.delimiterStart !== !1 && !f && y.push("|"),
				n.padding !== !1 &&
					!(n.alignDelimiters === !1 && w === "") &&
					(n.delimiterStart !== !1 || f) &&
					y.push(" "),
				n.alignDelimiters !== !1 && y.push(b),
				y.push(w),
				n.alignDelimiters !== !1 && y.push(N),
				n.padding !== !1 && y.push(" "),
				(n.delimiterEnd !== !1 || f !== u - 1) && y.push("|");
		}
		m.push(n.delimiterEnd === !1 ? y.join("").replace(/ +$/, "") : y.join(""));
	}
	return m.join(`
`);
}
...
function Rm(e, t, n, r) {
	const i = n.enter("blockquote"),
		o = n.createTracker(r);
	o.move("> "), o.shift(2);
	const a = n.indentLines(n.containerFlow(e, o.current()), Fm);
	return i(), a;
}
function Fm(e, t, n) {
	return ">" + (n ? "" : " ") + e;
...
function jm(e, t) {
	return Ao(e, t.inConstruct, !0) && !Ao(e, t.notInConstruct, !1);
}
function Ao(e, t, n) {
...
function Um(e, t, n, r) {
	...
	if (Vm(e, n)) {
		const f = n.enter("codeIndented"),
			d = n.indentLines(o, Wm);
		return f(), d;
	}
	const l = n.createTracker(r),
		s = i.repeat(Math.max(Bm(o, i) + 1, 3)),
		u = n.enter("codeFenced");
	let c = l.move(s);
	if (e.lang) {
		const f = n.enter(`codeFencedLang${a}`);
		(c += l.move(
			n.safe(e.lang, { before: c, after: " ", encode: ["`"], ...l.current() }),
		)),
			f();
	}
	if (e.lang && e.meta) {
...
function os(e, t, n, r) {
	const i = Gm(n),
		...
		l = a.move(i);
	let s = a.move(
		n.containerPhrasing(e, { after: i, before: l, ...a.current() }),
	);
	const u = s.charCodeAt(0),
		c = nr(r.before.charCodeAt(r.before.length - 1), u, i);
	c.inside && (s = un(u) + s.slice(1));
	const f = s.charCodeAt(s.length - 1),
		d = nr(r.after.charCodeAt(0), f, i);
	d.inside && (s = s.slice(0, -1) + un(f));
	const h = a.move(i);
	return (
		o(),
...
`,
	...
	return (
		/^[\t ]/.test(u) && (u = un(u.charCodeAt(0)) + u.slice(1)),
		(u = u ? a + " " + u : a),
...
function hs(e, t, n, r) {
	...
	if (fs(e, n)) {
		...
		return (
			(f += a.move(
				n.containerPhrasing(e, { before: f, after: ">", ...a.current() }),
			)),
			(f += a.move(">")),
			l(),
			(n.stack = c),
...
function i1(e, t, n, r) {
	const i = n.enter("list"),
		o = n.bulletCurrent;
	let a = e.ordered ? r1(n) : Yi(n);
	const l = e.ordered ? (a === "." ? ")" : ".") : n1(n);
...
function m1(e, t, n) {
	const r = (ms(n) + (n.options.ruleSpaces ? " " : "")).repeat(d1(n));
...
function p1() {
	return {
		enter: { table: g1, tableData: Io, tableHeader: Io, tableRow: y1 },
		exit: {
			codeText: v1,
			table: x1,
			tableData: Gr,
...
function v1(e) {
	let t = this.resume();
	this.data.inTable && (t = t.replace(/\\([\\|])/g, w1));
...
`,
		...
		handlers: { inlineCode: d, table: a, tableCell: s, tableRow: l },
	};
	function a(h, m, x, S) {
		return u(c(h, x, S), h.align);
	}
	function l(h, m, x, S) {
		const y = f(h, x, S),
			w = u([y]);
...
`),
	...
	function s(h, m, x, S) {
		const y = x.enter("tableCell"),
			w = x.enter("phrasing"),
			b = x.containerPhrasing(h, { ...S, before: o, after: o });
		return w(), y(), b;
	}
	function u(h, m) {
		return Mm(h, { align: m, alignDelimiters: r, padding: n, stringLength: i });
	}
	function c(h, m, x) {
		const S = h.children;
		let y = -1;
	...
	function f(h, m, x) {
		...
		const w = [],
			b = m.enter("tableRow");
		for (; ++y < S.length; ) w[y] = s(S[y], h, m, x);
		return b(), w;
	}
	function d(h, m, x) {
		let S = gs.inlineCode(h, m, x);
...
function k1() {
	return {
		exit: {
			taskListCheckValueChecked: Do,
			taskListCheckValueUnchecked: Do,
			paragraph: E1,
		},
	};
}
...
function C1(e, t, n, r) {
	const i = e.children[0],
		...
		l = n.createTracker(r);
	o && l.move(a);
	let s = gs.listItem(e, t, n, { ...r, ...l.current() });
...
function A1() {
	return [im(), Cm(), Dm(), p1(), k1()];
}
function T1(e) {
	return { extensions: [am(), Am(e), Lm(), b1(e), S1()] };
}
const I1 = { tokenize: O1, partial: !0 },
	xs = { tokenize: M1, partial: !0 },
	ys = { tokenize: z1, partial: !0 },
	vs = { tokenize: R1, partial: !0 },
	D1 = { tokenize: F1, partial: !0 },
	ws = { name: "wwwAutolink", tokenize: N1, previous: ks },
	bs = { name: "protocolAutolink", tokenize: _1, previous: Ss },
	Ze = { name: "emailAutolink", tokenize: P1, previous: Es },
	Ue = {};
function L1() {
	return { text: Ue };
}
let dt = 48;
for (; dt < 123; )
	(Ue[dt] = Ze), dt++, dt === 58 ? (dt = 65) : dt === 91 && (dt = 97);
Ue[43] = Ze;
Ue[45] = Ze;
Ue[46] = Ze;
Ue[95] = Ze;
...
function P1(e, t, n) {
	...
	return a;
	function a(f) {
		return !gi(f) || !Es.call(r, r.previous) || Ki(r.events)
			? n(f)
			: (e.enter("literalAutolink"), e.enter("literalAutolinkEmail"), l(f));
	}
	function l(f) {
		return gi(f) ? (e.consume(f), l) : f === 64 ? (e.consume(f), s) : n(f);
	}
	function s(f) {
		return f === 46
			? e.check(D1, c, u)(f)
...
function N1(e, t, n) {
	...
	return i;
	function i(a) {
		return (a !== 87 && a !== 119) || !ks.call(r, r.previous) || Ki(r.events)
			? n(a)
			: (e.enter("literalAutolink"),
				e.enter("literalAutolinkWww"),
				e.check(I1, e.attempt(xs, e.attempt(ys, o), n), n)(a));
	}
	function o(a) {
...
function _1(e, t, n) {
	...
	return a;
	function a(f) {
		return (f === 72 || f === 104) && Ss.call(r, r.previous) && !Ki(r.events)
			? (e.enter("literalAutolink"),
	...
	function l(f) {
		...
		if (f === 58) {
			...
			if (d === "http" || d === "https") return e.consume(f), s;
		}
		return n(f);
	}
	function s(f) {
		return f === 47 ? (e.consume(f), o ? u : ((o = !0), s)) : n(f);
	}
	function u(f) {
		return f === null || Zn(f) || le(f) || xt(f) || cr(f)
			? n(f)
			: e.attempt(xs, e.attempt(ys, c), n)(f);
	}
	function c(f) {
	...
	function r(l) {
		return l === 33 ||
			...
			: l === 38
				...
				: l === 93
					? (e.consume(l), i)
					: l === 60 || l === null || le(l) || xt(l)
						? t(l)
						: n(l);
	}
	function i(l) {
		return l === null || l === 40 || l === 91 || le(l) || xt(l) ? t(l) : r(l);
	}
	function o(l) {
		return we(l) ? a(l) : n(l);
	}
	function a(l) {
		return l === 59 ? (e.consume(l), r) : we(l) ? (e.consume(l), a) : n(l);
	}
}
function F1(e, t, n) {
	return r;
...
const j1 = { tokenize: q1, partial: !0 };
function B1() {
	return {
		document: {
			91: {
				...
				tokenize: W1,
				continuation: { tokenize: $1 },
				exit: G1,
			},
		},
		text: {
			91: { name: "gfmFootnoteCall", tokenize: U1 },
			93: {
...
function V1(e, t, n) {
	...
	function l(s) {
		...
		const u = Me(r.sliceSerialize({ start: a.end, end: r.now() }));
...
function U1(e, t, n) {
	...
	function u(f) {
		if (o > 999 || (f === 93 && !a) || f === null || f === 91 || le(f))
			return n(f);
		if (f === 93) {
			e.exit("chunkString");
			const d = e.exit("gfmFootnoteCallString");
			return i.includes(Me(r.sliceSerialize(d)))
				? (e.enter("gfmFootnoteCallLabelMarker"),
					e.consume(f),
					e.exit("gfmFootnoteCallLabelMarker"),
		...
		return le(f) || (a = !0), o++, e.consume(f), f === 92 ? c : u;
	}
	function c(f) {
...
function W1(e, t, n) {
	...
	function c(m) {
		if (a > 999 || (m === 93 && !l) || m === null || m === 91 || le(m))
			return n(m);
		if (m === 93) {
			e.exit("chunkString");
			const x = e.exit("gfmFootnoteDefinitionLabelString");
			return (
				(o = Me(r.sliceSerialize(x))),
				e.enter("gfmFootnoteDefinitionLabelMarker"),
				e.consume(m),
				e.exit("gfmFootnoteDefinitionLabelMarker"),
		...
		return le(m) || (l = !0), a++, e.consume(m), m === 92 ? f : c;
	}
	function f(m) {
		return m === 91 || m === 92 || m === 93 ? (e.consume(m), a++, c) : c(m);
	}
	function d(m) {
		return m === 58
			? (e.enter("definitionMarker"),
				...
				te(e, h, "gfmFootnoteDefinitionWhitespace"))
			: n(m);
	}
	function h(m) {
		return t(m);
...
function $1(e, t, n) {
	return e.check(vn, t, e.attempt(j1, t, n));
}
function G1(e) {
			...
			if (
				...
				for (; u--; )
					if (
						...
						h && Te(d, d.length, 0, fr(h, a.slice(u + 1, s), l)),
							Te(d, d.length, 0, [
								["exit", f, l],
								["enter", a[s][1], l],
								["exit", a[s][1], l],
	...
	function o(a, l, s) {
		...
		function d(m) {
			return u === 126 && c[c.length - 1][1].type !== "characterEscape"
				? s(m)
				: (a.enter("strikethroughSequenceTemporary"), h(m));
		}
		function h(m) {
			const x = Mt(u);
			if (m === 126) return f > 1 ? s(m) : (a.consume(m), f++, h);
			if (f < 2 && !n) return s(m);
...
function J1() {
	return { flow: { null: { name: "table", tokenize: Z1, resolveAll: ep } } };
}
function Z1(e, t, n) {
	const r = this;
	let i = 0,
	...
	function l(k) {
		...
		for (; C > -1; ) {
			const P = r.events[C][1].type;
			if (P === "lineEnding" || P === "linePrefix") C--;
			else break;
		}
		const A = C > -1 ? r.events[C][1].type : null,
			T = A === "tableHead" || A === "tableRow" ? E : s;
		return T === E && r.parser.lazy[r.now().line] ? n(k) : T(k);
	}
	function s(k) {
		return e.enter("tableHead"), e.enter("tableRow"), u(k);
	}
	function u(k) {
		return k === 124 || ((a = !0), (o += 1)), c(k);
	}
	function c(k) {
		return k === null
			? n(k)
	...
	function x(k) {
		return Z(k) ? te(e, S, "whitespace")(k) : S(k);
	}
	function S(k) {
		return k === 58
			? ((o += 1),
	...
	function y(k) {
		return k === 45 ? (e.enter("tableDelimiterFiller"), w(k)) : L(k);
	}
	function w(k) {
		return k === 45
			? (e.consume(k), w)
			: k === 58
				? ((a = !0),
					...
					e.exit("tableDelimiterMarker"),
					b)
				: (e.exit("tableDelimiterFiller"), b(k));
	}
	function b(k) {
		return Z(k) ? te(e, N, "whitespace")(k) : N(k);
	}
	function N(k) {
		return k === 124
			? m(k)
...
function ep(e, t) {
		...
		h[0] === "enter"
			...
			: m.type === "tableHead"
				...
				: m.type === "tableRow" || m.type === "tableDelimiterRow"
					? ((s = n),
						o[1] !== 0
							? ((a[0] = a[1]), (f = Mn(d, t, o, i, n, f)))
							: a[1] !== 0 && (f = Mn(d, t, a, i, n, f)),
						(i = 0))
					: i &&
						(m.type === "data" ||
							m.type === "tableDelimiterMarker" ||
	...
	for (
		s !== 0 && Lo(d, t, s, u, c), d.consume(t.events), n = -1;
		++n < t.events.length;
...
function Mn(e, t, n, r, i, o) {
	...
	return (
		i !== void 0 &&
			((o.end = Object.assign({}, Tt(t.events, i))),
			e.add(i, 0, [["exit", o, t]]),
			(o = void 0)),
		o
	);
...
const tp = { name: "tasklistCheck", tokenize: rp };
function np() {
	return { text: { 91: tp } };
}
function rp(e, t, n) {
	...
	function l(s) {
		return U(s) ? t(s) : Z(s) ? e.check({ tokenize: ip }, t, n)(s) : n(s);
	}
}
function ip(e, t, n) {
...
function lp(e) {
	...
	i.push(ap(n)), o.push(A1()), a.push(T1(n));
}
function Cs() {
	const { t: e, ...t } = ge();
	return {
		tm: Be.useCallback(
			(r, i) =>
				g.jsx("div", {
					className: "markdown",
					children: g.jsx(Yd, { remarkPlugins: [lp], children: e(r, i ?? {}) }),
				}),
			[e],
		),
		...t,
...
const sp = 5,
	up = () => {
		const { t: e } = ge(),
			...
			n = Q.useRef(0),
			r = () => {
				(n.current += 1), n.current === sp && ((n.current = 0), i());
			},
			i = () => {
				globalThis.localStorage.setItem($u, "true"),
					alert("posthog ignore set to true");
			};
		return g.jsx(ze, {
			titleKey: "aboutMe",
			hideTitle: !0,
			children: g.jsxs(X.div, {
				onClick: r,
				initial: "hidden",
				whileInView: "visible",
				viewport: { amount: 0.1, once: !0 },
	...
	bn = ({ children: e, className: t, to: n }) =>
		g.jsx("a", {
			href: n,
			target: "_blank",
			onClick: (r) => {
				r.target.blur(), r.stopPropagation();
			},
	...
	Zt = [
		...
		{ alt: "message", text: "send a message", href: "/contact", image: cp },
		{
			alt: "linkedin",
			...
			children: g.jsxs(X.div, {
				...
				children: [
					g.jsxs("div", {
						...
						children: [
							g.jsx(zn, { contactInformation: Zt[0] }),
							g.jsx(zn, { contactInformation: Zt[1] }),
						],
					}),
					g.jsxs("div", {
						className: "flex flex-wrap justify-center gap-9",
						children: [
							g.jsx(zn, { contactInformation: Zt[2] }),
							g.jsx(zn, { contactInformation: Zt[3] }),
						],
					}),
				],
			}),
		}),
	zn = ({ contactInformation: e }) => {
		const t = e.alt === "message",
			n = Zo();
		return g.jsx(ol, {
			iconButton: !0,
			ariaLabel: e.text,
			onClick: () => {
				t && n("/contact", { preventScrollReset: !0 });
			},
			children: t
				? g.jsx(ni, { alt: e.alt, src: e.image })
				: g.jsx(bn, {
						className: "flex h-full w-full",
						to: e.href,
						children: g.jsx(ni, { alt: e.alt, src: e.image }),
					}),
		});
	},
	pr =
	...
	xp = "/assets/core-values-finder-_vg3Bk_m.svg",
	yp = "/assets/curriculum-generator-DqWsR_Qr.svg",
	vp = "/assets/d-cide-DPbF-IOk.svg",
	wp =
	...
	kp = [
		{ name: "MUI (Material-UI)", link: "https://mui.com/", icon: bp },
		{ name: "Framer Motion", link: "https://www.framer.com/motion/", icon: wp },
	],
	Sp = [
		{ name: "d-cide", link: "https://d-cide.me/", icon: vp },
		{
	...
	Cp = () => {
		...
		const { t: e } = ge(),
			[t, n] = Q.useState(null),
			r = (i = t == null ? void 0 : t.items) == null ? void 0 : i[0];
		return (
			Q.useEffect(() => {
				try {
					fetch(Ip)
					...
					console.error("Error fetching Stack Overflow data:", o);
				}
			}, []),
			g.jsxs(g.Fragment, {
				children: [
					...
					g.jsx(bn, {
						...
						children: g.jsxs(X.div, {
							...
							variants: { visible: { opacity: 1 }, hidden: { opacity: 0 } },
							viewport: { amount: 0.9, once: !0 },
							initial: "hidden",
							whileInView: "visible",
							"aria-label": e("stackOverflowProfile"),
							className:
										...
										g.jsxs("div", {
											children: [
												...
												g.jsx("div", {
													className: "text-xl",
													children: (
														(r == null ? void 0 : r.reputation) ?? Qt.reputation
								...
								g.jsxs("div", {
									...
									children: [
										g.jsx(Yr, {
											color: "#D0A600",
											number:
												(r == null ? void 0 : r.badge_counts.gold) ??
												Qt.goldBadge,
										}),
										g.jsx(Yr, {
											color: "#707A81",
											number:
												(r == null ? void 0 : r.badge_counts.silver) ??
												Qt.silverBadge,
										}),
										g.jsx(Yr, {
											color: "#986400",
											number:
												(r == null ? void 0 : r.badge_counts.bronze) ??
												Qt.bronzeBadge,
										}),
									],
								}),
	...
	Yr = ({ color: e, number: t }) =>
		g.jsxs("div", {
			...
			children: [
				...
				g.jsx("span", { className: "text-md mb-1 ml-2", children: t }),
			],
		}),
	Ap = () => {
		const { t: e } = ge();
		return g.jsxs(g.Fragment, {
			children: [
				g.jsx("h3", {
					className: "mb-6 text-lg font-semibold",
					children: e("openSourceContributions"),
				}),
				g.jsx(X.div, {
					initial: "hidden",
					whileInView: "visible",
	...
	Tp = () => {
		...
		return g.jsxs(g.Fragment, {
			children: [
				...
				g.jsx("div", {
					className: "flex",
					children: g.jsx(X.div, {
						className: "m-auto grid grid-cols-2 gap-8",
						initial: "hidden",
						whileInView: "visible",
						viewport: { amount: 0.2, once: !0 },
						transition: { staggerChildren: 0.3 },
						children: Sp.map((t) =>
							g.jsx(
								X.div,
	...
	Dp = "/assets/meditating-DFmFxTkz.webp",
	Xi =
	...
	Lp = [
		{ coreValueKey: "excellence", explanationKey: "sustainableArchitecture" },
		{ coreValueKey: "accountable", explanationKey: "standForDecisions" },
		{ coreValueKey: "passion", explanationKey: "loveWhatIDo" },
		{ coreValueKey: "kindness", explanationKey: "eagerToHelp" },
	],
	Pp = () =>
		g.jsx(ze, {
			titleKey: "coreValues",
					...
					g.jsxs("div", {
						...
						children: [
							...
							g.jsx(X.div, {
								...
								children: Lp.map((e) =>
									g.jsx(Np, { coreValue: e }, e.coreValueKey),
								),
							}),
						],
					}),
		...
		return g.jsxs(X.div, {
			...
			children: [
				g.jsx("h3", {
					...
					children: t(e.coreValueKey),
				}),
				g.jsx("p", {
					className: "mt-0.5 opacity-90",
					children: t(e.explanationKey),
				}),
			],
		});
	},
	_p = "/assets/conference-C-jMqmSc.svg",
	As = "/assets/graduate-cap-D8bg-hWP.svg",
	Op = { en: Di, de: qu, es: Gu };
function Qi() {
	const { i18n: e, t } = ge(),
		n = Op[e.language] || Di,
		r = (o) => kc(o, "MMM yyyy", { locale: n });
	return {
		formatDate: r,
		formatTimePeriod: (o, a) => {
			const l = a === "today" ? new Date() : a,
				s = (Sa(l, o) + 1) / 12,
				u = new Intl.NumberFormat(e.language, {
					maximumFractionDigits: 1,
					minimumFractionDigits: s % 1 === 0 ? 0 : 1,
				}),
				c =
					s > 1
						? `${u.format(s)}${t("yearAbbreviation")}`
						: `${Sa(l, o)}${t("monthAbbreviation")}`;
			return a === "today"
				? `${r(o)} - ${t("present")} (${c})`
				: `${r(o)} - ${r(a)} (${c})`;
		},
...
const Mp = [
		...
		{ name: "Good Code", instructor: "Michael P", date: new Date("2020-03") },
		{
	...
	zp = [
		{ name: "Valencia Digital Summit", date: new Date("2024-11") },
		{ name: "Embedded World", date: new Date("2024-04") },
		{ name: "UXDX Dublin", date: new Date("2023-10") },
		{ name: "React Miami", date: new Date("2022-04") },
		{ name: "React Summit Amsterdam", date: new Date("2022-05") },
		{ name: "Scrum Day Stuttgart", date: new Date("2020-05") },
		{ name: "UXDX Berlin", date: new Date("2025-05") },
		{ name: "Greentech Festival", date: new Date("2025-05") },
		{ name: "GITEX Europe", date: new Date("2025-05") },
	],
	Rp = () => {
		const e = [...Mp, ...zp].sort(
			(t, n) => n.date.getTime() - t.date.getTime(),
		);
		return g.jsx(ze, {
		...
		return g.jsxs(g.Fragment, {
			children: [
				...
				g.jsxs("div", {
					...
					children: [
						g.jsx("div", { className: "truncate text-base", children: e.name }),
						g.jsx("div", {
							className: "text-sm opacity-80",
							children: `${e.instructor} – ${t(e.date)}`,
						}),
					],
				}),
			],
...
const Po =
	...
	Vp = "/assets/me-with-macbook-B9QyoX3G.webp",
	Hp = "/assets/office-CDw-dCQ2.svg",
	Up =
	...
	Wp = "/assets/th-wildau-DuUyfi7E.svg",
	Ts = new Date().getFullYear() - new Date("2015-02").getFullYear(),
	$p = [
		{
			logo: Wp,
			logoHeight: 55,
	...
	qp = () =>
		g.jsx(ze, { titleKey: "experienceAndEducation", children: g.jsx(Yp, {}) }),
	Yp = () => {
		const e = [...Gp, ...$p].sort(
			(t, n) => n.startDate.getTime() - t.startDate.getTime(),
		);
		return g.jsx("div", {
					...
					"div",
					{
						...
						children: [
							g.jsx("div", {
								...
								children: !r && g.jsx(No, { isOdd: r, item: t }),
							}),
							g.jsxs("div", {
								...
								children: [
									g.jsx("div", {
										...
										children: g.jsx("span", {
											className: `mx-auto flex h-full w-[3px] rounded-b-full opacity-60 ${i ? "from-secondary bg-linear-to-t" : "bg-secondary"}`,
										}),
									}),
									g.jsx(X.div, {
										initial: "hidden",
										whileInView: "visible",
										viewport: { amount: "all", once: !0 },
										variants: { visible: { scale: 1 }, hidden: { scale: 0 } },
										className: `${t.type === "work" ? "shadow-md-turquoise" : "shadow-md-purple"} border-secondary/10 from-neutral to-neutral-dark flex rounded-full border-2 border-solid bg-linear-to-br bg-contain p-3`,
										children: g.jsx("img", {
											loading: "lazy",
											width: "40",
											height: "40",
											alt:
												t.type === "work" ? "office building" : "graduate cap",
											src: t.type === "work" ? Hp : As,
										}),
									}),
									g.jsx("div", {
										className: "flex-1 pt-2",
										children: g.jsx("span", {
											className: `mx-auto flex h-full w-[3px] rounded-t-full opacity-60 ${o ? "from-secondary bg-linear-to-b" : "bg-secondary"}`,
										}),
									}),
								],
							}),
	...
	No = ({ item: e, isOdd: t }) => {
		const { t: n } = ge(),
			{ formatTimePeriod: r } = Qi(),
			i = {
				visible: { opacity: 1, x: 0 },
				hidden: { opacity: 0, x: t ? 100 : -100 },
			};
		return g.jsx(X.div, {
			initial: "hidden",
			whileInView: "visible",
			...
			variants: i,
			className: `my-5 flex max-w-fit ${t ? "ml-3 justify-start text-left md:ml-6" : "mr-3 ml-auto justify-end text-right md:mr-6"}`,
			children: g.jsxs("div", {
				...
				children: [
					g.jsx(bn, {
						...
						children: g.jsx(X.img, {
							...
							width: "100",
							height: e.logoHeight,
							style: { height: e.logoHeight },
							alt: cn(e.logo),
							src: e.logo,
							className: `mb-2 w-[100px] object-contain hover:cursor-pointer ${t ? "object-left" : "ml-auto object-right"}`,
						}),
					}),
					g.jsx("div", {
					...
					g.jsx("div", {
						...
						children: r(e.startDate, e.endDate),
					}),
					g.jsx("div", {
						className: "text-sm leading-tight opacity-80 md:text-base",
						children: n(e.locationKey),
					}),
				],
			}),
		});
	},
	Kp = "/assets/happy-DPJINb75.svg",
	Xp = "/assets/smartphone-CzsfzUV7.svg",
	Qp = "/assets/strong-BU9Tpe2U.svg",
	Jp = () => {
		const { t: e } = ge();
		return g.jsx(ze, {
			titleKey: "facts",
			children: g.jsx("div", {
				...
				children: g.jsxs("div", {
					...
					children: [
						g.jsx(Kr, {
							number: Ts,
							label: e("yearsOfExperience"),
							icon: Qp,
							alt: "strong",
						}),
						g.jsx(Kr, {
							number: 23,
							label: e("developedApps"),
							icon: Xp,
							alt: "smartphone",
						}),
						g.jsx(Kr, {
							number: 13,
							label: e("happyCustomers"),
							icon: Kp,
							alt: "happy face",
						}),
					],
	...
	Kr = ({ number: e, label: t, icon: n, alt: r }) => {
		const i = Q.useRef(null),
			{ scrollYProgress: o } = pl({ target: i }),
			a = Jn(o, [0.9, 0.6], [0, e + 1]);
		return (
			Q.useEffect(
				() => (
					i.current && (i.current.textContent = "0"),
					a.on("change", (l) => {
						i.current &&
							(l >= e
								? (i.current.textContent = `${e}+`)
								: (i.current.textContent = l.toFixed(0)));
					}),
					() => {
						a.destroy();
					}
			...
			g.jsxs("div", {
				className:
					"relative col-span-1 flex min-w-[220px] flex-col rounded-lg p-4",
				children: [
					g.jsx("img", {
						"aria-hidden": "true",
						alt: "",
					...
					g.jsx("div", { ref: i, className: "mt-3 text-2xl font-semibold" }),
					g.jsx("div", { className: "mt-4 text-xl", children: t }),
				],
			})
		);
	};
...
var Is = typeof window < "u",
	...
	_o = function (e) {
		...
		t[e] = function (r) {
			...
			return (o.state = r), window.dispatchEvent(o), i;
		};
	};
Is && (_o("pushState"), _o("replaceState"));
var eg = function () {
	...
	tg = function () {
		var e = Q.useState(Rn("load")),
			t = e[0],
			n = e[1];
		return (
			Q.useEffect(function () {
				var r = function () {
						return n(Rn("popstate"));
					},
					i = function () {
						return n(Rn("pushstate"));
					},
					o = function () {
						return n(Rn("replacestate"));
					};
				return (
					Wn(window, "popstate", r),
					Wn(window, "pushstate", i),
					Wn(window, "replacestate", o),
					function () {
						$n(window, "popstate", r),
							$n(window, "pushstate", i),
							$n(window, "replacestate", o);
					}
				);
			}, []),
			t
	...
	ng = typeof Event == "function";
const rg = Is && ng ? tg : eg;
var ig = function (e) {
		var t = Q.useRef(e);
		(t.current = e),
			Zp(function () {
...
const lg = new Set(["", "what_i_can_do_for_you", "contact"]),
	sg = {
		hidden: {
			opacity: 0,
			y: 0,
	...
	ug = 2e3,
	cg = () => {
		const { visibleSection: e } = wl(),
			t = Zo(),
			n = Zt.find((o) => o.alt === "message"),
			r = rg(),
			i = vl();
		return (
			Q.useEffect(() => {
				lg.has(e) || r.pathname === "/contact"
					? i.start("hidden")
					: e.includes("community_contributions")
						? setTimeout(() => {
								i.start("shake");
							}, ug)
						: i.start("visible");
			...
			n
				? g.jsx(X.div, {
						...
						children: g.jsx(ol, {
							...
							ariaLabel: n.text,
							onClick: () => {
								t("/contact", { preventScrollReset: !0 });
							},
							children: g.jsx(ni, { alt: n.alt, src: n.image }),
						}),
					})
				: null
		);
	...
	fg = () => {
		...
		return g.jsxs("div", {
			...
			children: [
				e("designedAndCodedPrefix"),
				" ",
				g.jsx("span", { "aria-label": e("love"), children: "♡" }),
				" ",
				e("designedAndCodedSuffix"),
			],
		});
	},
	hg =
	...
	mg = () => {
		const { t: e } = ge(),
			...
			u = ii(0),
			c = (f) => {
				if ((f.target.blur(), t.current)) {
					const d = t.current.offsetTop + t.current.offsetHeight;
					Cf(window.scrollY, d, {
						duration: 2.5,
						onUpdate(h) {
							window.scrollTo(0, h);
				...
				g.jsxs("div", {
					...
					children: [
						g.jsxs(X.h1, {
							...
							children: [
								g.jsx("span", { children: e("hiImChristian") }),
								g.jsx(yg, {}),
							],
						}),
						g.jsx(X.p, {
							...
							children: e("iDontJustProgramFeatures"),
						}),
						g.jsx(X.button, {
							style: { y: o, boxShadow: "0px 0px 90px -15px #00DFD8" },
							whileTap: { scale: 1 },
							whileHover: { scale: 1.1 },
							onClick: c,
							className:
	...
	pg = ({ mouseX: e, mouseY: t }) => {
		const n = Jn(e, (i) => i * -0.7),
			r = Jn(t, (i) => i * -0.5);
		return g.jsxs(g.Fragment, {
			children: [
				g.jsx(X.img, {
...
const Qr = ["fullStackDeveloper", "uxUiDesigner"],
	Fn = 0.03,
	gg = 2500,
	xg = 200,
	Oo = " ";
function yg() {
	...
	Q.useEffect(() => {
		const c = () => {
			...
			f = () => {
				a.start("hidden"),
					setTimeout(c, i * Fn * 1e3),
					setTimeout(d, i * Fn * 1e3 + xg);
			},
			d = () => {
				l || s(!0), a.start("visible"), setTimeout(f, gg);
			};
		d();
	}, []);
	const u = r.split(" ");
	return g.jsxs("span", {
		...
		"aria-label": o,
		children: [
			`${e("fullStackDeveloperPrefix")}${Oo}`,
			u.map((c, f) => {
				const h = [...(f + 1 === u.length ? c : c + Oo)],
					m = u.slice(0, f).reduce((x, S) => x + S.length, 0);
				return g.jsx(
					"span",
					{
						"aria-hidden": !0,
						...
						children: h.map((x, S) =>
							g.jsx(
								X.div,
								{
									initial: { opacity: l ? 0 : 1 },
									animate: a,
									variants: {
										hidden: {
											opacity: 0,
											transition: { delay: (i - m - S - 1) * Fn },
										},
										visible: {
											opacity: 1,
											transition: { delay: (m + S) * Fn },
										},
									},
									children: x,
								},
...
const vg = "/assets/feijoada-DSFp2IyW.svg",
	wg = "/assets/hamburguer-CtYINk2L.svg",
	bg = "/assets/paella-B4EbEGz3.svg",
	kg = "/assets/pretzel-lgHGjIp-.svg",
	Sg = [
		{ languageKey: "english", levelKey: "fluent", icon: wg },
		{ languageKey: "german", levelKey: "fluent", icon: kg },
		{ languageKey: "spanish", levelKey: "fluent", icon: bg },
		{ languageKey: "portuguese", levelKey: "goodCommand", icon: vg },
	],
	Eg = () => {
		const { t: e } = ge();
		return g.jsx(ze, {
						...
						"div",
						{
							...
							children: [
								...
								g.jsx("div", {
									...
									children: e(t.languageKey),
								}),
								g.jsx("div", {
									className: "mt-1 text-base",
									children: e(t.levelKey),
								}),
							],
						},
						t.languageKey,
...
function Ig() {
	...
	return (
		...
		{ isNarrowView: Q.useMemo(() => e <= Tg, [e]) }
	);
}
const Dg = "/assets/artist-C7nh18kN.svg",
	Lg = "/assets/face-with-sunglasses-CPN58VpN.svg",
	Pg = "/assets/robot-clKX3WjG.svg",
	Ng = "/assets/rocket-B6g9WbFC.svg",
	_g = "/assets/strategy-BgiiLw5R.svg",
	Og = [
		{
			logo: Lg,
			...
			children: g.jsxs("div", {
				...
				children: [
					...
					g.jsx(X.div, {
						...
						...t,
						children: Og.map((n) =>
							g.jsx(zg, { offer: n, isNarrowView: e }, n.titleKey),
						),
					}),
				],
			}),
				...
				children: [
					n &&
						g.jsx("div", {
							...
							children: g.jsx(Mo, { offer: e, isOpen: n }),
						}),
					g.jsx(X.div, {
						onClick: a,
						style: { zIndex: i },
						layout: !0,
						className: ` ${n ? "fixed inset-0 mx-3 flex" : "relative"}`,
						children: g.jsx(Mo, { isExpandable: !0, offer: e, isOpen: n }),
					}),
				],
			},
			e.titleKey,
	...
	Mo = ({ isExpandable: e, offer: t, isOpen: n }) => {
		const { t: r } = ge(),
			{ tm: i } = Cs();
		return g.jsxs(X.div, {
			layout: e,
			className: `border-secondary/10 from-neutral to-neutral-dark relative flex cursor-pointer rounded-2xl border-2 border-solid bg-linear-to-br p-4 text-left ${n && e ? "from-neutral/70 to-neutral-dark/70 m-auto h-auto w-full max-w-lg flex-wrap bg-linear-to-br backdrop-blur-sm" : "h-64 w-64 flex-col md:h-56 md:w-56"} ${n && !e ? "invisible" : "visible"}`,
			children: [
				g.jsx(X.button, {
					layout: e ? "preserve-aspect" : !1,
					"aria-label": r(n ? "expand" : "contract"),
					className: `absolute top-2.5 right-2.5 cursor-pointer ${n ? "h-7 w-7" : "h-6 w-6"}`,
					children: g.jsx("img", {
						width: 28,
						height: 28,
						src: n ? Cg : Ag,
						"aria-label": r(n ? "expand" : "contract"),
						alt: r(n ? "expand" : "contract"),
					}),
				}),
				g.jsx(X.img, {
					layout: e ? "preserve-aspect" : !1,
					...
					height: "70",
					src: t.logo,
					className: `pointer-events-none select-none ${n ? "mx-4 mt-4 mb-auto h-[170px] w-[170px]" : "my-4 h-[105px] w-[105px] md:h-[70px] md:w-[70px]"}`,
				}),
				g.jsxs(X.div, {
					className: `flex-1 ${n ? "min-w-[230px]" : "min-w-0"}`,
					layout: e,
					children: [
						g.jsx(X.h3, {
							layout: e ? "preserve-aspect" : !1,
						...
						n &&
							g.jsx(X.div, {
								...
								children: i(t.descriptionTranslationKey, { years: Ts }),
							}),
					],
				}),
			],
	...
	jg = () => {
		...
		return g.jsx(ze, {
			...
			children: g.jsxs("div", {
				...
				children: [
					g.jsx(zo, { skills: Rg, title: e("webDevelopment") }),
					g.jsx(zo, { skills: Fg, title: e("uxUiDesign") }),
				],
			}),
		});
	},
				...
				g.jsx(X.div, {
					...
					children: e.map((n) =>
						g.jsx(
							...
							{
								variants: { visible: { scale: 1 }, hidden: { scale: 0 } },
								className: `${t === "Web Development" ? "shadow-xs-turquoise" : "shadow-xs-purple"} border-secondary/10 from-neutral to-neutral-dark inline-block rounded-full border-2 border-solid bg-linear-to-br px-3 py-1 capitalize`,
								children: n,
							},
							n,
						),
...
var Ro = "(prefers-reduced-motion: reduce)",
	Pt = 1,
	Hg = 2,
	zt = 3,
	Vt = 4,
...
function ce(e) {
	return e.bind.apply(e, [null].concat(ut(arguments, 1)));
}
var Ds = setTimeout,
	xi = function () {};
function Fo(e) {
...
function Ve(e, t) {
	Ye(e, ot(t) ? t.split(" ") : t, !0);
}
function Cn(e, t) {
	Pe(t, e.appendChild.bind(e));
}
function ta(e, t) {
	Pe(e, function (n) {
...
function gt(e, t, n) {
	return (
		e &&
			(n ? dn(e).reverse() : dn(e)).forEach(function (r) {
				r !== "__proto__" && t(e[r], r);
			}),
		e
	);
...
function mn(e) {
	return (
		ut(arguments, 1).forEach(function (t) {
			gt(t, function (n, r) {
				e[r] = t[r];
			});
		}),
...
function K(e, t, n) {
	fn(t)
		...
		: Pe(e, function (r) {
				Zi(n) || n === "" ? He(r, t) : r.setAttribute(t, String(n));
			});
}
function _t(e, t, n) {
	var r = document.createElement(e);
	return t && (ot(t) ? Ve(r, t) : K(r, t)), n && Cn(n, r), r;
}
function _e(e, t, n) {
	if (Sn(n)) return getComputedStyle(e)[t];
	Zi(n) || (e.style[t] = "" + n);
}
function pn(e, t) {
	_e(e, "display", t);
...
function na(e, t) {
	return t ? ut(e.querySelectorAll(t)) : [];
}
function Ke(e, t) {
	Ye(e, t, !1);
}
...
function mt(e) {
	return ot(e) ? e : e ? e + "px" : "";
}
var Tn = "splide",
	ra = "data-" + Tn;
function an(e, t) {
	if (!e) throw new Error("[" + Tn + "] " + (t || ""));
}
var lt = Math.min,
	ir = Math.max,
	ar = Math.floor,
...
var Vo = {};
function Wg(e) {
	return "" + e + ia((Vo[e] = (Vo[e] || 0) + 1));
}
function Rs() {
	var e = [];
	function t(a, l, s, u) {
		i(a, l, function (c, f, d) {
			var h = "addEventListener" in c,
				m = h
					? c.removeEventListener.bind(c, f, s, u)
					: c.removeListener.bind(c, s);
			h ? c.addEventListener(f, s, u) : c.addListener(s),
				e.push([c, f, d, s, m]);
		});
	}
	function n(a, l, s) {
		i(a, l, function (u, c, f) {
			e = e.filter(function (d) {
				return d[0] === u && d[1] === c && d[2] === f && (!s || d[3] === s)
					? (d[4](), !1)
					: !0;
			});
		});
	...
	return { bind: t, unbind: n, dispatch: r, destroy: o };
}
var ct = "mounted",
	bi = "ready",
	Je = "move",
	...
	$s = "arrows:mounted",
	Gs = "arrows:updated",
	qs = "pagination:mounted",
	Ys = "pagination:updated",
	la = "navigation:mounted",
	sa = "autoplay:play",
	Ks = "autoplay:playing",
	ua = "autoplay:pause",
	ca = "lazyload:loaded",
...
function fe(e) {
	var t = e ? e.event.bus : document.createDocumentFragment(),
		n = Rs();
	function r(o, a) {
		n.bind(t, En(o).join(" "), function (l) {
			a.apply(a, Ji(l.detail) ? l.detail : []);
		});
	}
	function i(o) {
		n.dispatch(t, o, ut(arguments, 1));
	}
	return (
		e && e.event.on(oa, n.destroy),
		mn(n, { bus: t, on: r, off: ce(n.unbind, t), emit: i })
	);
}
function vr(e, t, n, r) {
	var i = Date.now,
	...
	function m() {
		l && cancelAnimationFrame(l), (a = 0), (l = 0), (s = !0);
	}
	function x(y) {
		e = y;
	}
	...
	return { start: f, rewind: h, pause: d, cancel: m, set: x, isPaused: S };
}
function Gg(e) {
	var t = e;
	function n(i) {
...
function Yg(e, t, n) {
	...
	function c(m, x) {
		var S = matchMedia(x);
		a.bind(S, "change", f), l.push([m, S]);
	}
	function f() {
		var m = r.is(rr),
			x = n.direction,
			S = l.reduce(function (y, w) {
				return it(y, w[1].matches ? w[0] : {});
			}, {});
		jo(n),
			h(S),
			n.destroy
				...
				: m
					? (u(!0), e.mount())
					: x !== n.direction && e.refresh();
	}
	function d(m) {
		matchMedia(Ro).matches && (m ? it(n, o) : jo(n, dn(o)));
	}
	function h(m, x, S) {
		it(n, m),
			x && it(Object.getPrototypeOf(n), m),
			(S || !r.is(Pt)) && e.emit(be, n);
	}
	return { setup: s, destroy: u, reduce: d, set: h };
}
var wr = "Arrow",
	br = wr + "Left",
	kr = wr + "Right",
...
var Xe = "role",
	...
	tu = Re + "hidden",
	ha = Re + "orientation",
	xn = Re + "roledescription",
	Wo = Re + "live",
	$o = Re + "busy",
	Go = Re + "atomic",
	da = [Xe, Ot, Xg, In, eu, Le, fa, tu, ha, xn],
	We = Tn + "__",
	ft = "is-",
	Zr = Tn,
	qo = We + "track",
...
function l3(e, t) {
	if (Ls(e.closest)) return e.closest(t);
	for (var n = e; n && n.nodeType === 1 && !hn(n, t); ) n = n.parentElement;
	return n;
}
var s3 = 5,
	Yo = 200,
	...
	ti = "touchend touchcancel mouseup click";
function u3(e, t, n) {
	var r = fe(e),
		i = r.on,
		o = r.bind,
	...
	function y(I) {
		var M = da.concat("style");
		Qe(u), Ke(a, c), Ke(d, f), He([d, h], M), He(a, I ? M : ["style", xn]);
	}
	function w() {
		Ke(a, c),
			Ke(d, f),
	...
	function b() {
		(d = L("." + qo)),
			(h = An(d, "." + Qg)),
			an(d && h, "A track/list element is missing."),
			qn(u, Ns(h, "." + Er + ":not(." + nu + ")")),
			gt(
				{ arrows: ma, pagination: Ar, prev: ru, next: iu, bar: e3, toggle: t3 },
				function (I, M) {
					s[M] = L("." + I);
				},
			),
			mn(s, { root: a, track: d, list: h, slides: u });
	}
	function N() {
		var I = a.id || Wg(Tn),
			M = n.role;
		(a.id = I),
			(d.id = d.id || I + "-track"),
			(h.id = h.id || I + "-list"),
			!Oe(a, Xe) && a.tagName !== "SECTION" && M && K(a, Xe, M),
			K(a, xn, l.carousel),
			K(h, Xe, "presentation");
	}
	function L(I) {
		var M = Ms(a, I);
		return M && l3(M, "." + Zr) === a ? M : void 0;
	}
	function E(I) {
		return [
			I + "--" + n.type,
			I + "--" + n.direction,
			n.drag && I + "--draggable",
			n.isNavigation && I + "--nav",
			I === Zr && vt,
		];
	}
	return mn(s, { setup: x, mount: S, destroy: y });
}
var Ft = "slide",
	Ut = "loop",
	Dn = "fade";
function c3(e, t, n, r) {
	...
	function E() {
		b ||
			((r.id = u.id + "-slide" + ia(t + 1)),
			K(r, Xe, m ? "tabpanel" : "group"),
			K(r, xn, h.slide),
			K(r, Le, w || wi(h.slideLabel, [t + 1, e.length]))),
			I();
	}
	function I() {
		l(r, "click", ce(a, aa, B)),
			l(r, "keydown", ce(a, Xs, B)),
			o([Ht, Qs, bt], C),
			o(la, z),
			d && o(Je, k);
	}
	...
	function z() {
		var V = e.splides
			.map(function (p) {
				var j = p.splide.Components.Slides.getAt(t);
				return j ? j.slide.id : "";
			})
			.join(" ");
		K(r, Le, wi(h.slideX, (b ? n : t) + 1)),
			K(r, In, V),
			K(r, Xe, x ? "button" : ""),
			x && He(r, xn);
	}
	...
	function C() {
		if (!L) {
			var V = e.index;
			A(), T(), Ye(r, ou, t === V - 1), Ye(r, lu, t === V + 1);
		}
	}
	function A() {
		var V = R();
		V !== Bo(r, vt) &&
			(Ye(r, vt, V), K(r, eu, (f && V) || ""), a(V ? Fs : js, B));
	}
	function T() {
		var V = q(),
			p = !V && (!R() || b);
		if (
			(e.state.is([Vt, kn]) || K(r, tu, p || ""),
			K(na(r, c.focusableNodes || ""), Ot, p ? -1 : ""),
			x && K(r, Ot, p ? -1 : 0),
			V !== Bo(r, ki) && (Ye(r, ki, V), a(V ? Bs : Vs, B)),
			!V && document.activeElement === r)
		) {
			var j = s.Slides.getAt(e.index);
			j && _s(j.slide);
		}
	}
	function P(V, p, j) {
	...
	function R() {
		var V = e.index;
		return V === t || (c.cloneStatus && V === n);
	}
	function q() {
		if (e.is(Dn)) return R();
		var V = De(s.Elements.track),
			p = De(r),
			j = S("left", !0),
			$ = S("right", !0);
		return ar(V[j]) <= gn(p[j]) && ar(p[$]) <= gn(V[$]);
	}
	function W(V, p) {
		var j = Se(V - t);
		return !b && (c.rewind || e.is(Ut)) && (j = lt(j, e.length - j)), j <= p;
	}
	var B = {
		index: t,
		slideIndex: n,
...
function f3(e, t, n) {
	...
	function y(C) {
		var A = t.Controller,
			T = A.toIndex(C),
			P = A.hasFocus() ? 1 : n.perPage;
		return E(function (R) {
			return Yn(R.index, T, T + P - 1);
		});
	}
	function w(C) {
		return E(C)[0];
	...
	function b(C, A) {
		Pe(C, function (T) {
			if ((ot(T) && (T = Os(T)), Ps(T))) {
				var P = s[A];
				P ? ta(T, P) : Cn(u, T), Ve(T, n.classes.slide), M(T, ce(o, Rt));
			}
		}),
			o(pe);
	}
	...
	function E(C) {
		return c.filter(
			Ls(C)
				? C
				: function (A) {
						return ot(C) ? hn(A.slide, C) : ea(En(C), A.index);
					},
		);
	}
	function I(C, A, T) {
...
function h3(e, t, n) {
	var r = fe(e),
		...
		y;
	function w() {
		b(), o(window, "resize load", qg(ce(a, Rt))), i([be, pe], b), i(Rt, N);
	}
	function b() {
		(x = n.direction === Sr),
			_e(c, "maxWidth", mt(n.width)),
			_e(f, s("paddingLeft"), L(!1)),
			_e(f, s("paddingRight"), L(!0)),
			N(!0);
	}
	function N(B) {
		var V = De(c);
		(B || S.width !== V.width || S.height !== V.height) &&
			(_e(f, "height", E()),
			m(s("marginRight"), mt(n.gap)),
			m("width", M()),
			m("height", z(), !0),
			(S = V),
			a(xr),
			y !== (y = W()) && (Ye(c, uu, y), a($g, y)));
	}
	function L(B) {
		var V = n.padding,
			p = s(B ? "right" : "left");
		return (V && mt(V[p] || (fn(V) ? 0 : V))) || "0px";
	}
	function E() {
		var B = "";
		return (
			x &&
				((B = I()),
				an(B, "height or heightRatio is missing."),
				(B = "calc(" + B + " - " + L(!1) + " - " + L(!0) + ")")),
			B
		);
	}
	function I() {
		return mt(n.height || De(d).width * n.heightRatio);
	}
	function M() {
		return n.autoWidth ? null : mt(n.fixedWidth) || (x ? "" : k());
	}
	function z() {
		return mt(n.fixedHeight) || (x ? (n.autoHeight ? null : k()) : I());
	}
	function k() {
		var B = mt(n.gap);
		return (
	...
	function A(B, V) {
		var p = h(B || 0);
		return p ? De(p.slide)[s("width")] + (V ? 0 : R()) : 0;
	}
	function T(B, V) {
		var p = h(B);
		if (p) {
			var j = De(p.slide)[s("right")],
				$ = De(d)[s("left")];
			return Se(j - $) + (V ? 0 : R());
		}
		return 0;
	...
	function P(B) {
		return T(e.length - 1) - T(0) + A(0, B);
	}
	function R() {
		var B = h(0);
		return (B && parseFloat(_e(B.slide, s("marginRight")))) || 0;
	}
	function q(B) {
		return parseFloat(_e(f, s("padding" + (B ? "Right" : "Left")))) || 0;
	}
	function W() {
		return e.is(Dn) || P(!0) > C();
	}
	return {
		mount: w,
		resize: N,
...
function m3(e, t, n) {
	var r = fe(e),
		...
		u;
	function c() {
		i(pe, f), i([be, Rt], h), (u = S()) && (m(u), t.Layout.resize(!0));
	}
	function f() {
		d(), c();
	}
	...
	function m(y) {
		var w = a.get().slice(),
			b = w.length;
		if (b) {
			for (; w.length < y; ) qn(w, w);
			qn(w.slice(-y), w.slice(0, y)).forEach(function (N, L) {
				var E = L < y,
					I = x(N.slide, L);
				E ? ta(I, w[0].slide) : Cn(o.list, I),
					qn(s, I),
					a.register(I, L - y + (E ? 0 : b), N.index);
			});
		}
	}
	function x(y, w) {
		var b = y.cloneNode(!0);
		return Ve(b, n.classes.clone), (b.id = e.root.id + "-clone" + ia(w + 1)), b;
	}
	function S() {
		var y = n.clones;
		if (!e.is(Ut)) y = 0;
		else if (Sn(y)) {
			var w = n[l("fixedWidth")] && t.Layout.slideSize(0),
				b = w && gn(De(o.track)[l("width")] / w);
			y = b || (n[l("autoWidth")] && e.length) || n.perPage * d3;
		}
		return y;
	}
...
function p3(e, t, n) {
	var r = fe(e),
		...
		b;
	function N() {
		(b = t.Transition), i([ct, xr, be, pe], L);
	}
	function L() {
		t.Controller.isBusy() || (t.Scroll.cancel(), I(e.index), t.Slides.update());
	}
	function E(p, j, $, v) {
		p !== j && B(p > $) && (C(), M(k(P(), p > $), !0)),
			a(Vt),
	...
	function M(p, j) {
		if (!e.is(Dn)) {
			var $ = j ? p : z(p);
			_e(y, "transform", "translate" + m("X") + "(" + $ + "px)"),
				p !== $ && o(Qs);
		}
	}
	function z(p) {
	...
	function k(p, j) {
		var $ = p - W(j),
			v = d();
		return (p -= x(v * (gn(Se($) / v) || 1)) * (j ? 1 : -1)), p;
	}
	function C() {
		M(P(), !0), b.cancel();
	}
	function A(p) {
		for (
			var j = t.Slides.get(), $ = 0, v = 1 / 0, re = 0;
			re < j.length;
			re++
		) {
			var he = j[re].index,
	...
	function P() {
		var p = m("left");
		return De(y)[p] - De(w)[p] + x(u(!1));
	}
	function R(p) {
		return n.trimSpace && e.is(Ft) && (p = It(p, 0, x(d(!0) - f()))), p;
	}
	function q(p) {
		var j = n.focus;
		return j === "center" ? (f() - s(p, !0)) / 2 : +j * s(p) || 0;
	}
	function W(p) {
		return T(p ? t.Controller.getEnd() : 0, !!n.trimSpace);
	}
	function B(p) {
		var j = x(k(P(), p));
		return p ? j >= 0 : j <= y[m("scrollWidth")] - De(w)[m("width")];
	}
	function V(p, j) {
		j = Sn(j) ? P() : j;
		var $ = p !== !0 && x(j) < x(W(!1)),
...
function g3(e, t, n) {
	var r = fe(e),
		...
		I;
	function M() {
		z(), i([be, pe, or], z), i(xr, k);
	}
	function z() {
		(L = d(!0)), (E = n.perMove), (I = n.perPage), (b = B());
		var _ = It(w, 0, h ? b : L - 1);
		_ !== w && ((w = _), a.reposition());
	}
	function k() {
		b !== B() && o(or);
	}
	function C(_, J, ie) {
		if (!he()) {
			var ne = T(_),
				de = W(ne);
			de > -1 && (J || de !== w) && ($(de), a.move(ne, de, N, ie));
		}
	}
	function A(_, J, ie, ne) {
		t.Scroll.scroll(_, J, ie, function () {
			var de = W(a.toIndex(l()));
			$(h ? lt(de, b) : de), ne && ne();
		});
	}
	function T(_) {
	...
	function P(_, J) {
		var ie = E || (re() ? 1 : I),
			ne = R(w + ie * (_ ? -1 : 1), w, !(E || re()));
		return ne === -1 && x && !zs(l(), s(!_), 1) ? (_ ? 0 : b) : J ? ne : W(ne);
	}
	function R(_, J, ie) {
		if (f() || re()) {
			var ne = q(_);
					...
					? !E && (Yn(0, _, J, !0) || Yn(b, J, _, !0))
						...
						: m
							...
							: n.rewind
								? (_ = _ < 0 ? b : 0)
								: (_ = -1)
					: ie && _ !== J && (_ = V(p(J) + (_ < J ? -1 : 1)));
		} else _ = -1;
		return _;
	}
	function q(_) {
		if (x && n.trimSpace === "move" && _ !== w)
			for (var J = l(); J === u(_, !0) && Yn(_, 0, e.length - 1, !n.rewind); )
				_ < w ? --_ : ++_;
		return _;
	}
	function W(_) {
	...
	function V(_) {
		return It(re() ? _ : I * _, 0, b);
	}
	function p(_) {
		return re() ? lt(_, b) : ar((_ >= b ? L - 1 : _) / I);
	}
	function j(_) {
		var J = a.toIndex(_);
		return x ? It(J, 0, b) : J;
	...
	function re() {
		return !Sn(n.focus) || n.isNavigation;
	}
	function he() {
		return e.state.is([Vt, kn]) && !!n.waitForTransition;
	}
	return {
		mount: M,
		go: C,
...
var x3 = "http://www.w3.org/2000/svg",
	y3 =
...
function v3(e, t, n) {
	...
	function L() {
		...
		A && !(m && x) && z(),
			m &&
				...
				(mn(w, { prev: m, next: x }),
				pn(h, A ? "" : "none"),
				Ve(h, (y = ma + "--" + n.direction)),
				A && (I(), C(), K([m, x], In, d.id), a($s, m, x)));
	}
	function E() {
		r.destroy(),
			Ke(h, y),
			S ? (yt(f ? [m, x] : h), (m = x = null)) : He([m, x], da);
	}
	function I() {
		i([ct, Ht, pe, bt, or], C),
			o(x, "click", ce(M, ">")),
	...
	function C() {
		if (m && x) {
			var A = e.index,
				T = c.getPrev(),
				P = c.getNext(),
				R = T > -1 && A < T ? s.last : s.prev,
				q = P > -1 && A > P ? s.first : s.next;
			(m.disabled = T < 0),
				(x.disabled = P < 0),
				K(m, Le, R),
				K(x, Le, q),
	...
	return { arrows: w, mount: b, destroy: E, update: C };
}
var w3 = ra + "-interval";
function b3(e, t, n) {
	var r = fe(e),
		...
		S = h === "pause";
	function y() {
		h && (w(), d && K(d, In, u.track.id), S || b(), E());
	}
	function w() {
		n.pauseOnHover &&
			o(f, "mouseenter mouseleave", function (z) {
				(m = z.type === "mouseenter"), L();
			}),
			n.pauseOnFocus &&
				o(f, "focusin focusout", function (z) {
					(x = z.type === "focusin"), L();
				}),
			d &&
				o(d, "click", function () {
	...
	function b() {
		s() &&
			t.Slides.isEnough() &&
			(l.start(!n.resetProgress), (x = m = S = !1), E(), a(sa));
	}
	function N(z) {
		z === void 0 && (z = !0), (S = !!z), E(), s() || (l.pause(), a(ua));
	}
	function L() {
		S || (m || x ? N(!1) : b());
	}
	function E() {
		d && (Ye(d, vt, !S), K(d, Le, n.i18n[S ? "play" : "pause"]));
	}
	function I(z) {
		var k = u.bar;
		k && _e(k, "width", z * 100 + "%"), a(Ks, z);
	}
	function M(z) {
		var k = t.Slides.getAt(z);
		l.set((k && +Oe(k.slide, w3)) || n.interval);
	}
	return { mount: y, destroy: l.cancel, play: b, pause: N, isPaused: s };
}
function k3(e, t, n) {
	var r = fe(e),
		i = r.on;
	function o() {
		n.cover && (i(ca, ce(l, !0)), i([ct, be, pe], ce(a, !0)));
	}
	function a(s) {
		t.Slides.forEach(function (u) {
			var c = An(u.container || u.slide, "img");
			c && c.src && l(s, c, u);
		});
	}
	function l(s, u, c) {
...
function I3(e, t, n) {
	...
	function y(I, M, z, k, C) {
		var A = s();
		if ((N(), z && (!d || !c()))) {
			var T = t.Layout.sliderSize(),
				P = vi(I) * T * ar(Se(I) / T) || 0;
			I = l.toPosition(t.Controller.toDest(I % T)) + P;
		}
		var R = zs(A, I, 1);
		(x = 1),
			(M = R ? 0 : M || ir(Se(I - A) / A3, T3)),
			(m = k),
			(h = vr(M, w, ce(b, A, I, C), 1)),
			a(kn),
			o(yr),
			h.start();
	}
	...
	function b(I, M, z, k) {
		var C = s(),
			...
			T = (A - C) * x;
		f(C + T),
			d && !z && c() && ((x *= C3), Se(T) < S3 && y(u(c(!0)), E3, !1, m, !0));
	}
	function N() {
		h && h.cancel();
	}
	...
	function E(I) {
		var M = n.easingFunc;
		return M ? M(I) : 1 - Math.pow(1 - I, 4);
	}
	return { mount: S, destroy: N, scroll: y, cancel: L };
}
var Dt = { passive: !1, capture: !0 };
function D3(e, t, n) {
	var r = fe(e),
		i = r.on,
		o = r.emit,
	...
	function R(H) {
		if ((s.is(Gn) || (s.set(Gn), o(Hs)), H.cancelable))
			if (I) {
				u.translate(b + ie(re(H)));
				var se = he(H) > Yo,
					Fe = M !== (M = w());
				(se || Fe) && B(H), (z = !0), o(Us), qe(H);
			} else j(H) && ((I = p(H)), qe(H));
	}
	function q(H) {
		s.is(Gn) && (s.set(zt), o(Ws)),
			I && (V(H), qe(H)),
			l(C, ei, R),
			l(C, ti, q),
			(I = !1);
	...
	function V(H) {
		var se = $(H),
			Fe = v(se),
			et = n.rewind && n.rewindByDrag;
		h(!1),
			E
				? f.scroll(Fe, 0, n.snap)
				: e.is(Dn)
					? f.go(S(vi(se)) < 0 ? (et ? "<" : "-") : et ? ">" : "+")
					: e.is(Ft) && M && et
						? f.go(w(!0) ? ">" : "<")
						: f.go(f.toDest(Fe), !0),
			h(!0);
	...
	function p(H) {
		var se = n.dragMinThreshold,
			Fe = fn(se),
			et = (Fe && se.mouse) || 0,
			Pn = (Fe ? se.touch : +se) || 10;
		return Se(re(H)) > (de(H) ? Pn : et);
	}
	function j(H) {
		return Se(re(H)) > Se(re(H, !0));
	}
	function $(H) {
		if (e.is(Ut) || !M) {
			var se = he(H);
			if (se && se < Yo) return re(H) / se;
		}
		return 0;
	}
	function v(H) {
		return (
			...
			vi(H) *
				lt(
					Se(H) * (n.flickPower || 600),
					E ? 1 / 0 : t.Layout.listSize() * (n.flickMaxPages || 1),
				)
		);
	}
	function re(H, se) {
		return J(H, se) - J(_(H), se);
	}
	function he(H) {
		return yi(H) - yi(_(H));
	}
	...
	function J(H, se) {
		return (de(H) ? H.changedTouches[0] : H)["page" + x(se ? "Y" : "X")];
	}
	function ie(H) {
		return H / (M && e.is(Ft) ? s3 : 1);
	}
	function ne(H) {
		var se = n.noDrag;
		return !hn(H, "." + au + ", ." + Cr) && (!se || !hn(H, se));
	}
	function de(H) {
	...
	return { mount: A, disable: Ln, isDragging: kt };
}
var L3 = { Spacebar: " ", Right: kr, Left: br, Up: Js, Down: Zs };
function pa(e) {
	return (e = ot(e) ? e : e.key), L3[e] || e;
}
var Ko = "keydown";
function P3(e, t, n) {
	var r = fe(e),
		...
		c;
	function f() {
		d(), i(be, h), i(be, d), i(Je, x);
	}
	function d() {
		var y = n.keyboard;
		y && ((u = y === "global" ? window : l), o(u, Ko, S));
	}
	function h() {
		a(u, Ko);
	}
	...
	function S(y) {
		if (!c) {
			var w = pa(y);
			w === s(br) ? e.go("<") : w === s(kr) && e.go(">");
		}
	}
	return { mount: f, destroy: h, disable: m };
}
var on = ra + "-lazy",
	Kn = on + "-srcset",
	N3 = "[" + on + "], [" + Kn + "]";
function _3(e, t, n) {
	...
	function d() {
		Qe(c), h(), s ? y() : (o(u), i(u, m), m());
	}
	function h() {
		t.Slides.forEach(function (w) {
			na(w.slide, N3).forEach(function (b) {
				var N = Oe(b, on),
					L = Oe(b, Kn);
				if (N !== b.src || L !== b.srcset) {
					var E = n.classes.spinner,
						I = b.parentElement,
						M = An(I, "." + E) || _t("span", E, I);
					c.push([b, w, M]), b.src || pn(b, "none");
				}
			});
		});
	}
	function m() {
		(c = c.filter(function (w) {
			...
			return w[1].isWithin(e.index, b) ? x(w) : !0;
		})),
			c.length || o(u);
	}
	function x(w) {
	...
	function S(w, b) {
		var N = w[0],
			L = w[1];
		Ke(L.slide, Si),
			b.type !== "error" && (yt(w[2]), pn(N, ""), l(ca, N, L), l(Rt)),
			s && y();
	}
	function y() {
		c.length && x(c.shift());
	}
	return { mount: f, destroy: ce(Qe, c), check: m };
}
function O3(e, t, n) {
	var r = fe(e),
		i = r.on,
	...
	function w() {
		...
		m && pn(m, k ? "" : "none"),
			k &&
				...
				N(),
				z(),
				o(qs, { list: S, items: x }, M(e.index)));
	}
	function b() {
		S && (yt(m ? ut(S.children) : S), Ke(S, y), Qe(x), (S = null)), r.destroy();
	}
	function N() {
		var k = e.length,
			C = n.classes,
			A = n.i18n,
			T = n.perPage,
			P = c() ? u.getEnd() + 1 : gn(k / T);
		(S = m || _t("ul", C.pagination, s.track.parentElement)),
			Ve(S, (y = Ar + "--" + I())),
			K(S, Xe, "tablist"),
			K(S, Le, A.select),
			K(S, ha, I() === Sr ? "vertical" : "");
		for (var R = 0; R < P; R++) {
			var q = _t("li", null, S),
				W = _t("button", { class: C.page, type: "button" }, q),
				B = l.getIn(R).map(function (p) {
					return p.slide.id;
				}),
				V = !c() && T > 1 ? A.pageX : A.slideX;
			a(W, "click", ce(L, R)),
				n.paginationKeyboard && a(W, "keydown", ce(E, R)),
				K(q, Xe, "presentation"),
				K(W, Xe, "tab"),
				K(W, In, B.join(" ")),
				K(W, Le, wi(V, R + 1)),
				K(W, Ot, -1),
				x.push({ li: q, button: W, page: R });
		}
	}
	function L(k) {
		d(">" + k, !0);
	...
	function z() {
		...
		if (k) {
			var A = k.button;
			Ke(A, vt), He(A, Uo), K(A, Ot, -1);
		}
		if (C) {
			var T = C.button;
			Ve(T, vt), K(T, Uo, !0), K(T, Ot, "");
		}
		o(Ys, { list: S, items: x }, k, C);
	}
	return { items: x, mount: w, destroy: b, getAt: M, update: z };
}
var M3 = [" ", "Enter"];
function z3(e, t, n) {
	var r = n.isNavigation,
		...
		o = [];
	function a() {
		e.splides.forEach(function (m) {
			m.isParent || (u(e, m.splide), u(m.splide, e));
		}),
			r && c();
	}
	function l() {
	...
	function c() {
		var m = fe(e),
			x = m.on;
		x(aa, d), x(Xs, h), x([ct, be], f), o.push(m), m.emit(la, e.splides);
	}
	function f() {
		K(t.Elements.list, ha, n.direction === Sr ? "vertical" : "");
	}
	function d(m) {
		e.go(m.index);
	}
	...
	return {
		setup: ce(t.Media.set, { slideFocus: Sn(i) ? r : i }, !0),
		mount: a,
		destroy: l,
		remount: s,
	};
...
function R3(e, t, n) {
	var r = fe(e),
		...
		o = 0;
	function a() {
		n.wheel && i(t.Elements.track, "wheel", l, Dt);
	}
	function l(u) {
		if (u.cancelable) {
			var c = u.deltaY,
				f = c < 0,
				d = yi(u),
				h = n.wheelMinThreshold || 0,
				m = n.wheelSleep || 0;
			Se(c) > h && d - o > m && (e.go(f ? "<" : ">"), (o = d)), s(f) && qe(u);
		}
	}
	function s(u) {
		return (
			!n.releaseWheel || e.state.is(Vt) || t.Controller.getAdjacent(u) !== -1
		);
	}
	return { mount: a };
}
...
function j3(e, t, n) {
	...
	function c(h) {
		K(o, $o, h), h ? (Cn(o, l), s.start()) : (yt(l), s.cancel());
	}
	function f() {
		He(o, [Wo, Go, $o]), yt(l);
	}
	function d(h) {
		a && K(o, Wo, h ? "off" : "polite");
	}
	return { mount: u, disable: d, destroy: f };
}
...
function U3(e, t, n) {
	...
	function a(l, s) {
		r.style("transition", "opacity " + n.speed + "ms " + n.easing), Ds(s);
	}
	return { mount: i, start: a, cancel: xi };
}
function W3(e, t, n) {
	var r = t.Move,
		i = t.Controller,
		o = t.Scroll,
		a = t.Elements.list,
		l = ce(_e, a, "transition"),
		s;
	function u() {
		fe(e).bind(a, "transitionend", function (h) {
			h.target === a && s && (f(), s());
		});
	}
	function c(h, m) {
		var x = r.toPosition(h, !0),
			S = r.getPosition(),
			y = d(h);
		Se(x - S) >= 1 && y >= 1
			? n.useScroll
				? o.scroll(x, y, !1, m)
				: (l("transform " + y + "ms " + n.easing), r.translate(x, !0), (s = m))
			: (r.jump(h), m());
	}
	function f() {
		l(""), o.cancel();
...
var $3 = (function () {
		function e(n, r) {
			(this.event = fe()),
				...
				(this._o = {}),
				(this._E = {});
			var i = ot(n) ? Ms(document, n) : n;
			an(i, i + " is invalid."),
				(this.root = i),
				(r = it(
					{ label: Oe(i, Le) || "", labelledby: Oe(i, fa) || "" },
					H3,
					e.defaults,
					r || {},
				));
			try {
				it(r, JSON.parse(Oe(i, ra)));
			} catch {
				an(!1, "Invalid JSON");
			}
			this._o = Object.create(it({}, r));
		}
		var t = e.prototype;
		return (
			(t.mount = function (r, i) {
				var o = this,
					a = this.state,
					l = this.Components;
				an(a.is([Pt, rr]), "Already mounted!"),
					a.set(Pt),
					(this._C = l),
					(this._T = i || this._T || (this.is(Dn) ? U3 : W3)),
					(this._E = r || this._E);
				var s = mn({}, B3, this._E, { Transition: this._T });
				return (
					gt(s, function (u, c) {
						var f = u(o, l, o._o);
			...
			(t.emit = function (r) {
				var i;
				return (
					(i = this.event).emit.apply(i, [r].concat(ut(arguments, 1))), this
				);
			}),
			(t.add = function (r, i) {
			...
			(t.destroy = function (r) {
				...
				return (
					o.is(Pt)
						? fe(this).on(bi, this.destroy.bind(this, r))
						: (gt(
								this._C,
								function (a) {
...
var Xo = [
	...
	[$s, "onArrowsMounted"],
	[Gs, "onArrowsUpdated"],
	[qs, "onPaginationMounted"],
	[Ys, "onPaginationUpdated"],
	[la, "onNavigationMounted"],
	[sa, "onAutoplayPlay"],
	[Ks, "onAutoplayPlaying"],
	[ua, "onAutoplayPause"],
	[ca, "onLazyLoadLoaded"],
];
function xa(...e) {
...
function Ei(e, t) {
	if (Array.isArray(e) && Array.isArray(t))
		return e.length === t.length && !e.some((n, r) => !Ei(n, t[r]));
	if (lr(e) && lr(t)) {
		...
		return (
			n.length === r.length &&
			!n.some(
				(i) => !Object.prototype.hasOwnProperty.call(t, i) || !Ei(e[i], t[i]),
			)
		);
	}
	return e === t;
...
var fu = ({ children: e, className: t, ...n }) =>
		Be.createElement(
			"div",
			{ className: xa("splide__track", t), ...n },
			Be.createElement("ul", { className: "splide__list" }, e),
		),
	Y3 = class extends Be.Component {
		constructor() {
			super(...arguments),
				(this.splideRef = Be.createRef()),
				(this.slides = []);
		}
		componentDidMount() {
		...
		componentDidUpdate() {
			...
			e &&
				!Ei(this.options, e) &&
				((this.splide.options = e), (this.options = Ci({}, e)));
			const t = this.getSlides();
			G3(this.slides, t) || (this.splide.refresh(), (this.slides = t));
		}
		sync(e) {
			var t;
		...
		render() {
			...
			return Be.createElement(
				t,
				{
					className: xa("splide", e),
					ref: this.splideRef,
					...this.omit(i, ["options", ...Xo.map((o) => o[1])]),
				},
				n ? Be.createElement(fu, null, r) : r,
			);
		}
	},
	K3 = ({ children: e, className: t, ...n }) =>
		Be.createElement("li", { className: xa("splide__slide", t), ...n }, e);
/*!
 * Splide.js
 * Version  : 4.1.3
 * License  : MIT
 ...
 */ const X3 =
	...
	nx = "/assets/paula-BMpoXtCt.webp",
	rx = "/assets/quanted-logo-EwNJS1q2.png",
	ix = "/assets/smart-cube-360-BTWeojZV.svg",
	ax = "/assets/thomas-CNRGML95.png",
	Bn = [
		{
									...
									children: g.jsxs("div", {
										...
										children: [
											g.jsx("img", {
												loading: "lazy",
												width: "150",
												height: s.companyHeight,
												style: { width: 150, height: s.companyHeight },
												className: "z-10 mx-auto mt-2 object-contain",
												alt: cn(s.companyLogo),
												src: s.companyLogo,
											}),
											g.jsxs("div", {
												...
												children: [
													...
													g.jsxs("div", {
														...
														children: [
															...
															g.jsx("div", {
																className: "text-base",
																children: e(s.titleKey),
															}),
															g.jsx("div", {
																className: "text-sm",
																children: e(s.company),
															}),
														],
													}),
												],
								...
								g.jsx(
									"button",
									{
										...
										children: g.jsx("span", {
											style: {
												boxShadow:
													i === u ? `${Q3.primary} 0px 0px 12px 6px` : "unset",
											},
											className:
												"bg-secondary inline-block h-3 w-3 rounded-full",
										}),
									},
									s.testimonialKey,
								),
...
const Qo = ({ onClick: e, orientation: t }) => {
		const n = t === "left";
		return g.jsx("button", {
			className: "h-full w-full max-w-[200px] cursor-pointer",
			onClick: e,
			children: g.jsx("span", {
				className: `bg-grey/80 flex h-12 w-12 cursor-pointer rounded-full ${n ? "mr-auto ml-4" : "mr-4 ml-auto"}`,
				children: g.jsx("img", {
...
//# debugId=cd859ac8-54dc-5d09-94c6-7fae3f87b23b

!(function () {
	try {
		...
		n &&
			...
			(e._sentryDebugIds[n] = "f6db2979-8a65-5f01-aecc-6354dc4ba97d"));
	} catch (e) {}
})();
const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"assets/index.es-CTySJtlC.js",
			"assets/chunk-D4RADZKF-DVqrdyfo.js",
		]),
) => i.map((i) => d[i]);
import { w as j, u as D } from "./with-props-DPDmm-s_.js";
import {
	b as o,
	p as n,
	A as V,
...
import { u as L, i as T } from "./use-hydrated-Bl0M1cM4.js";
import {
	M as R,
	u as S,
	P as z,
...
class J extends o.Component {
	getSnapshotBeforeUpdate(e) {
		...
		if (t && e.isPresent && !this.props.isPresent) {
			const u = t.offsetParent,
				d = (u instanceof HTMLElement && u.offsetWidth) || 0,
				l = this.props.sizeRef.current;
			(l.height = t.offsetHeight || 0),
				(l.width = t.offsetWidth || 0),
				(l.top = t.offsetTop),
				(l.left = t.offsetLeft),
				(l.right = d - l.width - l.left);
		}
		return null;
	}
	componentDidUpdate() {}
...
function Y({ children: i, isPresent: e, anchorX: t }) {
	const u = o.useId(),
		d = o.useRef(null),
		l = o.useRef({ width: 0, height: 0, top: 0, left: 0, right: 0 }),
		{ nonce: f } = o.useContext(R);
	return (
		o.useInsertionEffect(() => {
			const { width: c, height: a, top: r, left: m, right: s } = l.current;
			if (e || !d.current || !c || !a) return;
			const x = t === "left" ? `left: ${m}` : `right: ${s}`;
        ...
        `),
				() => {
					document.head.contains(b) && document.head.removeChild(b);
				}
			);
		}, [e]),
		n.jsx(J, {
			...
			childRef: d,
			sizeRef: l,
			children: o.cloneElement(i, { ref: d }),
		})
	);
}
const Z = ({
		...
		s = o.useMemo(
			() => (
				(m = !1),
				{
					...
					onExitComplete: (x) => {
						a.set(x, !0);
						for (const b of a.values()) if (!b) return;
						u && u();
					},
					register: (x) => (a.set(x, !1), () => a.delete(x)),
				}
			),
			[t, a, u],
		);
	return (
		l && m && (s = { ...s }),
		o.useMemo(() => {
			a.forEach((x, b) => a.set(b, !1));
		}, [t]),
		o.useEffect(() => {
			!t && !a.size && u && u();
		}, [t]),
		f === "popLayout" &&
			(i = n.jsx(Y, { isPresent: t, anchorX: c, children: i })),
		n.jsx(z.Provider, { value: s, children: i })
	);
};
function Q() {
	return new Map();
...
const nn = ({
		...
		const [a, r] = U(f),
			...
			[_, E] = o.useState(m);
		H(() => {
			(x.current = !1), (b.current = m);
			for (let p = 0; p < _.length; p++) {
				const k = h(_[p]);
				s.includes(k) ? v.delete(k) : v.get(k) !== !0 && v.set(k, !1);
			}
		}, [_, s.length, s.join("-")]);
		const C = [];
		if (m !== y) {
			...
			for (let k = 0; k < _.length; k++) {
				const $ = _[k],
					g = h($);
				s.includes(g) || (p.splice(k, 0, $), C.push($));
			}
			return l === "wait" && C.length && (p = C), E(I(p)), M(m), null;
		}
		const { forceRender: P } = o.useContext(W);
		return n.jsx(n.Fragment, {
			children: _.map((p) => {
				const k = h(p),
					$ = f && !a ? !1 : m === _ || s.includes(k),
					g = () => {
	...
	an = function (e, t, u) {
		...
		function l(f) {
			...
			if (((c.payload = f), window.dispatchEvent(c), !c.defaultPrevented))
				throw f;
		}
		return d.then((f) => {
			for (const c of f || []) c.status === "rejected" && l(c.reason);
			return e().catch(l);
		});
	},
	q = ({ ...i }) => {
	...
	jn = j(function () {
		const e = V(),
			t = e == null ? void 0 : e.success,
			u = O(),
			d = o.useRef(null),
			{ t: l } = D(),
			f = () => {
				var x;
				const a = (x = d.current) == null ? void 0 : x.elements,
					r = a == null ? void 0 : a.namedItem("name"),
					m = a == null ? void 0 : a.namedItem("email"),
					s = a == null ? void 0 : a.namedItem("message");
				((r != null && r.value) ||
					(m != null && m.value && s != null && s.value)) &&
					T.capture("contact_form_close", {
						name: (r == null ? void 0 : r.value) ?? "",
						email: (m == null ? void 0 : m.value) ?? "",
						message: (s == null ? void 0 : s.value) ?? "",
					});
			};
		o.useEffect(() => {
			const a = () => {
						...
						children: [
							...
							t !== void 0 &&
								(t
									...
									: n.jsx(wn, {
											personalEmail:
												(e == null ? void 0 : e.personalEmail) ?? "",
										})),
							t === void 0 && n.jsx(In, { formRef: d }),
						],
					}),
				}),
			],
			...
			children: [
				...
				n.jsxs("div", {
					...
					children: [
						...
						n.jsx(X, { onClick: v, children: e("sendMessage") }),
					],
				}),
			],
		});
	},
	w = ({ label: i, type: e, name: t, ariaLabel: u, onChange: d }) =>
		n.jsxs("label", {
...
//# debugId=f6db2979-8a65-5f01-aecc-6354dc4ba97d
